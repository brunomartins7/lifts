...
Object.assign(ALTERNATIVES, {"barbell-bench-press": ["dumbbell-bench-press", "lever-chest-press"], "dumbbell-bench-press": ["barbell-bench-press", "lever-chest-press"], "lever-chest-press": ["barbell-bench-press", "dumbbell-bench-press"], "sled-hack-squat": ["sled-45-leg-press", "barbell-back-squat"], "sled-45-leg-press": ["sled-hack-squat", "barbell-back-squat"], "barbell-back-squat": ["sled-hack-squat", "sled-45-leg-press", "lever-leg-extension"], "cable-pulldown": ["pull-up-neutral-grip", "lever-front-pulldown", "cable-lateral-pulldown-with-v-bar"], "cable-lateral-pulldown-with-v-bar": ["cable-underhand-pulldown", "pull-up-neutral-grip", "cable-pulldown"], "lever-front-pulldown": ["cable-pulldown", "pull-up-neutral-grip", "cable-lateral-pulldown-with-v-bar"], "cable-one-arm-lateral-raise": ["cable-lateral-raise", "dumbbell-lateral-raise"], "cable-lateral-raise": ["cable-one-arm-lateral-raise", "dumbbell-lateral-raise"], "dumbbell-lateral-raise": ["cable-lateral-raise", "cable-one-arm-lateral-raise"], "cable-pushdown-with-rope-attachment": ["cable-triceps-pushdown-v-bar", "lever-triceps-extension", "cable-one-arm-tricep-pushdown"], "cable-triceps-pushdown-v-bar": ["cable-pushdown-with-rope-attachment", "lever-triceps-extension", "cable-one-arm-tricep-pushdown"], "cable-one-arm-tricep-pushdown": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "cable-pushdown-with-rope-attachment"], "lever-seated-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "sled-calf-press": ["lever-seated-calf-raise", "dumbbell-standing-calf-raise", "barbell-standing-calf-raise"], "dumbbell-standing-calf-raise": ["lever-seated-calf-raise", "sled-calf-press", "barbell-standing-calf-raise"], "barbell-romanian-deadlift": ["dumbbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-romanian-deadlift": ["barbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-stiff-leg-deadlift": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "dumbbell-incline-row": ["cable-seated-wide-grip-row", "lever-high-row", "cable-seated-row"], "cable-seated-row": ["lever-seated-row", "dumbbell-incline-row", "cable-rope-seated-row"], "lever-seated-row": ["cable-seated-row", "dumbbell-incline-row"], "dumbbell-incline-bench-press": ["barbell-incline-bench-press", "lever-incline-chest-press"], "barbell-incline-bench-press": ["dumbbell-incline-bench-press", "lever-incline-chest-press"], "lever-incline-chest-press": ["dumbbell-incline-bench-press", "barbell-incline-bench-press"], "cable-curl": ["dumbbell-standing-biceps-curl", "ez-barbell-curl", "dumbbell-incline-curl"], "dumbbell-standing-biceps-curl": ["cable-curl", "ez-barbell-curl", "dumbbell-incline-curl"], "ez-barbell-curl": ["cable-curl", "dumbbell-standing-biceps-curl", "barbell-curl"], "lever-seated-reverse-fly": ["cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "cable-cross-over-revers-fly": ["lever-seated-reverse-fly", "dumbbell-reverse-fly"], "dumbbell-reverse-fly": ["lever-seated-reverse-fly", "cable-cross-over-revers-fly"], "cable-kneeling-crunch": ["cable-seated-crunch", "crunch-floor", "weighted-crunch"], "weighted-crunch": ["cable-kneeling-crunch", "lever-seated-crunch"], "lever-seated-crunch": ["cable-kneeling-crunch", "weighted-crunch", "cable-seated-crunch"], "barbell-glute-bridge": ["cable-pull-through", "barbell-sumo-deadlift"], "cable-pull-through": ["barbell-glute-bridge", "barbell-sumo-deadlift"], "barbell-sumo-deadlift": ["barbell-glute-bridge", "cable-pull-through"], "dumbbell-seated-shoulder-press": ["lever-shoulder-press", "barbell-seated-overhead-press"], "lever-shoulder-press": ["dumbbell-seated-shoulder-press", "barbell-seated-overhead-press"], "barbell-seated-overhead-press": ["lever-shoulder-press", "dumbbell-seated-shoulder-press"], "cable-overhead-triceps-extension-rope-attachment": ["cable-one-arm-tricep-pushdown", "dumbbell-seated-triceps-extension", "lever-triceps-extension"], "dumbbell-seated-triceps-extension": ["cable-overhead-triceps-extension-rope-attachment", "cable-one-arm-tricep-pushdown", "lever-triceps-extension"], "lever-triceps-extension": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "cable-overhead-triceps-extension-rope-attachment"], "dumbbell-incline-curl": ["cable-hammer-curl-with-rope", "dumbbell-hammer-curl", "cable-one-arm-curl"], "cable-one-arm-curl": ["dumbbell-incline-curl", "lever-bicep-curl"], "lever-bicep-curl": ["dumbbell-incline-curl", "cable-one-arm-curl"], "dumbbell-seated-palms-up-wrist-curl": ["barbell-wrist-curl", "cable-wrist-curl"], "barbell-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "cable-wrist-curl"], "cable-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "barbell-wrist-curl"], "cable-standing-fly": ["cable-upper-chest-crossovers", "lever-seated-fly"], "cable-upper-chest-crossovers": ["cable-standing-fly", "lever-seated-fly"], "lever-seated-fly": ["cable-standing-fly", "cable-upper-chest-crossovers"], "barbell-reverse-curl": ["dumbbell-standing-reverse-curl", "cable-reverse-curl"], "dumbbell-standing-reverse-curl": ["barbell-reverse-curl", "cable-reverse-curl"], "cable-reverse-curl": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl"], "pull-up": ["cable-pulldown", "cable-lateral-pulldown-with-v-bar"], "dumbbell-standing-triceps-extension": ["cable-overhead-triceps-extension-rope-attachment", "ez-bar-standing-french-press", "dumbbell-seated-triceps-extension"], "ez-bar-standing-french-press": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-standing-triceps-extension"], "barbell-standing-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "barbell-good-morning": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "lever-seated-leg-curl": ["lever-lying-leg-curl", "lever-kneeling-leg-curl"], "lever-lying-leg-curl": ["lever-seated-leg-curl", "lever-kneeling-leg-curl"], "lever-kneeling-leg-curl": ["lever-seated-leg-curl", "lever-lying-leg-curl"], "cable-seated-crunch": ["cable-kneeling-crunch", "crunch-floor", "lever-seated-crunch"], "lever-leg-extension": ["barbell-back-squat", "barbell-front-squat"], "barbell-front-squat": ["lever-leg-extension", "barbell-back-squat"], "cable-underhand-pulldown": ["cable-lateral-pulldown-with-v-bar", "pull-up-neutral-grip", "chin-up"], "chin-up": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown"], "cable-rope-seated-row": ["cable-seated-row", "lever-t-bar-row"], "lever-t-bar-row": ["cable-seated-row", "cable-rope-seated-row"], "barbell-curl": ["ez-barbell-curl", "dumbbell-biceps-curl"], "dumbbell-biceps-curl": ["ez-barbell-curl", "barbell-curl"], "hanging-leg-raise": ["hanging-straight-leg-raise", "captains-chair-straight-leg-raise"], "hanging-straight-leg-raise": ["hanging-leg-raise", "captains-chair-straight-leg-raise"], "captains-chair-straight-leg-raise": ["hanging-leg-raise", "hanging-straight-leg-raise"], "pull-up-neutral-grip": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown", "cable-pulldown"], "crunch-floor": ["cable-kneeling-crunch", "cable-seated-crunch"], "cable-hammer-curl-with-rope": ["dumbbell-incline-curl", "dumbbell-hammer-curl"], "dumbbell-hammer-curl": ["dumbbell-incline-curl", "cable-hammer-curl-with-rope"], "dumbbell-reverse-wrist-curl": ["cable-reverse-wrist-curl", "barbell-reverse-wrist-curl"], "cable-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "barbell-reverse-wrist-curl"], "barbell-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-seated-wide-grip-row": ["dumbbell-incline-row", "lever-high-row"], "lever-high-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row"]});
...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Flat chest and lats", "focus": "Flat pressing, vertical pulling, lateral delts and moderate arms", "groups": [{"id": "A1", "name": "Flat chest press", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "lever-chest-press"], "sets": 3, "min": 6, "max": 10, "rir": 3, "rest": 150, "note": "The main chest movement goes first while pressing strength is highest."}]}, {"id": "A2", "name": "Vertical pull", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-pulldown", "pull-up-neutral-grip", "lever-front-pulldown"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "The lats are trained after pressing to alternate fatigue and protect chest performance."}]}, {"id": "A3", "name": "Lateral delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-one-arm-lateral-raise", "cable-lateral-raise", "dumbbell-lateral-raise"], "sets": 2, "min": 12, "max": 15, "rir": 2, "rest": 75, "note": "Low-fatigue direct lateral-delt work follows the compound lifts."}]}, {"id": "A4", "name": "Biceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-curl", "dumbbell-standing-biceps-curl", "ez-barbell-curl"], "sets": 2, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Direct biceps work is kept small because the pulldown already loads elbow flexion."}]}, {"id": "A5", "name": "Triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "lever-triceps-extension"], "sets": 2, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Direct triceps work is placed after pressing so it cannot reduce chest performance."}]}, {"id": "A6", "name": "Abs", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-kneeling-crunch", "cable-seated-crunch", "crunch-floor"], "sets": 2, "min": 12, "max": 15, "rir": 2, "rest": 60, "note": "Loaded trunk flexion finishes the session without affecting the upper-body lifts."}]}]}, {"id": "B", "name": "Shoulders and mid-back", "focus": "Shoulder pressing, one row, rear delts, arms and forearms", "groups": [{"id": "B1", "name": "Shoulder press", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["lever-shoulder-press", "dumbbell-seated-shoulder-press", "barbell-seated-overhead-press"], "sets": 3, "min": 8, "max": 12, "rir": 3, "rest": 150, "note": "The most fatigue-sensitive movement goes first and supplies the direct front-delt work."}]}, {"id": "B2", "name": "Mid-back row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-seated-row", "lever-seated-row", "dumbbell-incline-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "One row is enough here because another row exposure may follow on C."}]}, {"id": "B3", "name": "Rear delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["lever-seated-reverse-fly", "cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "sets": 2, "min": 12, "max": 15, "rir": 2, "rest": 75, "note": "Direct rear-delt work follows the row and avoids relying on secondary stimulus."}]}, {"id": "B4", "name": "Biceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-curl", "cable-hammer-curl-with-rope", "dumbbell-hammer-curl"], "sets": 2, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "The second direct biceps exposure is short because the row has already taxed the elbow flexors."}]}, {"id": "B5", "name": "Triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-overhead-triceps-extension-rope-attachment", "cable-one-arm-tricep-pushdown", "dumbbell-seated-triceps-extension"], "sets": 2, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "The overhead option trains the long head after the shoulder press."}]}, {"id": "B6", "name": "Forearms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-reverse-wrist-curl", "cable-reverse-wrist-curl", "barbell-reverse-wrist-curl"], "sets": 2, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "Direct forearm work is last so it cannot weaken the earlier row or curls."}]}]}, {"id": "C", "name": "Incline chest and back", "focus": "Incline pressing, vertical pulling, delts, abs and a reduced row exposure", "groups": [{"id": "C1", "name": "Incline chest press", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-bench-press", "barbell-incline-bench-press", "lever-incline-chest-press"], "sets": 3, "min": 8, "max": 12, "rir": 3, "rest": 150, "note": "The second chest angle is trained first, with the flat press separated by B."}]}, {"id": "C2", "name": "Vertical pull", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown", "pull-up-neutral-grip"], "sets": 3, "min": 8, "max": 12, "rir": 3, "rest": 120, "note": "A different grip gives the second weekly lat exposure without adding another row."}]}, {"id": "C3", "name": "Lateral delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-lateral-raise", "cable-one-arm-lateral-raise", "dumbbell-lateral-raise"], "sets": 2, "min": 12, "max": 15, "rir": 3, "rest": 75, "note": "This low-fatigue slot separates the pulldown from the row."}]}, {"id": "C4", "name": "Abs", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-kneeling-crunch", "cable-seated-crunch", "crunch-floor"], "sets": 2, "min": 12, "max": 15, "rir": 3, "rest": 60, "note": "The trunk work further separates the two back movements."}]}, {"id": "C5", "name": "Mid-back row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-seated-wide-grip-row", "dumbbell-incline-row", "lever-high-row"], "sets": 2, "min": 8, "max": 12, "rir": 3, "rest": 120, "note": "The reduced two-set exposure protects row quality when B and C are consecutive."}]}, {"id": "C6", "name": "Rear delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["lever-seated-reverse-fly", "cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "sets": 2, "min": 12, "max": 15, "rir": 3, "rest": 75, "note": "A controlled fly finishes the upper-back work without placing two rows together."}]}]}]}};
...
/* The two coached programmes, with the trade-off stated rather than implied.
   ...
   not a migration. */
const SPACING = {"chest": {"days": ["A", "C"], "weeklySets": 6, "minRecoveryDays": 0, "verdict": "C to A can be consecutive, but each exposure is three sets at 3 RIR and uses a different angle"}, "lats": {"days": ["A", "C"], "weeklySets": 6, "minRecoveryDays": 0, "verdict": "C to A can be consecutive, but each exposure is only three controlled sets"}, "midBack": {"days": ["B", "C"], "weeklySets": 5, "minRecoveryDays": 0, "verdict": "B to C can be consecutive, so C uses only two sets at 3 RIR"}, "frontDelts": {"days": ["B"], "weeklySets": 3, "minRecoveryDays": 2, "verdict": "Direct work is confined to B; chest pressing on A and C supplies secondary work"}, "lateralDelts": {"days": ["A", "C"], "weeklySets": 4, "minRecoveryDays": 0, "verdict": "C to A can be consecutive, but the exposure is only two low-fatigue sets each time"}, "rearDelts": {"days": ["B", "C"], "weeklySets": 4, "minRecoveryDays": 0, "verdict": "B to C can be consecutive, but each exposure is two controlled fly sets"}, "biceps": {"days": ["A", "B"], "weeklySets": 4, "minRecoveryDays": 0, "verdict": "A to B can be consecutive, but direct work is only two sets per session and pulling already contributes indirectly"}, "triceps": {"days": ["A", "B"], "weeklySets": 4, "minRecoveryDays": 0, "verdict": "A to B can be consecutive, but direct work is only two sets per session and pressing contributes indirectly"}, "forearms": {"days": ["B"], "weeklySets": 2, "minRecoveryDays": 2, "verdict": "Direct work is confined to B because rows, pulldowns and curls already load the grip"}, "abs": {"days": ["A", "C"], "weeklySets": 4, "minRecoveryDays": 0, "verdict": "C to A can be consecutive, but each exposure is two controlled loaded sets"}};
function renderPresetCard(){
  ...
  <div class="card"><div class="row" style="padding-top:0"><div><strong>Upper body, six exercises a day</strong><div class="small faint">Built for training on no fixed days, so it holds up even three days running.</div></div>
  ...
  ${rows}
  <div class="small faint" style="margin-top:11px">Where a muscle can land on consecutive days it only ever takes two or three sets, kept two to three reps from failure, which is light enough to repeat. Heavy pressing opens every session while you are fresh; grip work is last, because tired hands ruin the pulling that comes before it. Bench is never immediately followed by incline, and no session runs two rows back to back.</div></div>`;
}
...
if(!state.settings.programAppliedV4 && !state.session){
  try{
    ...
    state.settings.programAppliedV4 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
