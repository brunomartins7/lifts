...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Chest lead", "focus": "Horizontal and incline press, vertical pull, lateral delt", "groups": [{"id": "A1", "name": "Press and pull", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "lever-chest-press"], "sets": 3, "min": 6, "max": 10, "note": "Heaviest chest press of the week, done first while you are fresh."}, {"options": ["cable-pulldown", "cable-lateral-pulldown-with-v-bar", "pull-up"], "sets": 3, "min": 10, "max": 12, "note": "Placed between the two presses so your chest recovers before the incline."}]}, {"id": "A2", "name": "Incline and delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-bench-press", "barbell-incline-bench-press", "lever-incline-chest-press"], "sets": 3, "min": 8, "max": 12, "note": "Upper chest, with the pulldown between it and the bench."}, {"options": ["cable-one-arm-lateral-raise", "dumbbell-lateral-raise", "cable-lateral-raise"], "sets": 3, "min": 12, "max": 15, "note": "Direct lateral delt. The old program had almost none."}]}, {"id": "A3", "name": "Triceps and core", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-standing-triceps-extension", "ez-bar-standing-french-press"], "sets": 3, "min": 10, "max": 15, "note": "Overhead is what loads the triceps long head."}, {"options": ["cable-kneeling-crunch", "cable-seated-crunch", "lever-seated-crunch"], "sets": 3, "min": 12, "max": 15, "note": "Loaded, so abs progress like everything else."}]}]}, {"id": "B", "name": "Back lead", "focus": "Horizontal and vertical pull, shoulder press, rear delt, arms", "groups": [{"id": "B1", "name": "Row and press", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-row", "cable-seated-row", "lever-seated-row"], "sets": 3, "min": 10, "max": 12, "note": "Chest supported, so the back works and the hips cannot cheat."}, {"options": ["dumbbell-seated-shoulder-press", "barbell-seated-overhead-press", "lever-shoulder-press"], "sets": 3, "min": 8, "max": 12, "note": "Vertical press, kept away from the other row."}]}, {"id": "B2", "name": "Pulldown and rear delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown", "chin-up"], "sets": 3, "min": 10, "max": 12, "note": "A different pull angle, not a second row back to back."}, {"options": ["lever-seated-reverse-fly", "dumbbell-reverse-fly", "cable-cross-over-revers-fly"], "sets": 3, "min": 12, "max": 15, "note": "Rear delts trained directly rather than hoped for."}]}, {"id": "B3", "name": "Arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-curl", "dumbbell-standing-biceps-curl", "dumbbell-incline-curl"], "sets": 3, "min": 10, "max": 15, "note": "Constant tension right through the curl."}, {"options": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl", "cable-reverse-curl"], "sets": 3, "min": 12, "max": 20, "note": "Forearms and brachioradialis. You said you did not know this one \u2014 the guide is in the panel."}]}]}, {"id": "C", "name": "Detail and arms", "focus": "Row, chest adduction, lateral delt, arms, core", "groups": [{"id": "C1", "name": "Row and chest", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-seated-row", "cable-rope-seated-row", "lever-t-bar-row"], "sets": 3, "min": 10, "max": 12, "note": "Third back exposure of the week, on a different day to the others."}, {"options": ["cable-standing-fly", "cable-upper-chest-crossovers", "lever-seated-fly"], "sets": 3, "min": 12, "max": 15, "note": "Chest without another heavy press. Cables, because the dumbbell version felt wrong."}]}, {"id": "C2", "name": "Delts and triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-lateral-raise", "cable-lateral-raise", "cable-one-arm-lateral-raise"], "sets": 3, "min": 12, "max": 15, "note": "Second lateral delt slot. Width needs the volume."}, {"options": ["dumbbell-standing-triceps-extension", "cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension"], "sets": 3, "min": 10, "max": 15, "note": "Long head again, second exposure."}]}, {"id": "C3", "name": "Biceps and core", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["ez-barbell-curl", "barbell-curl", "dumbbell-biceps-curl"], "sets": 3, "min": 8, "max": 12, "note": "Heavier curl than Day B, at a wrist angle that stays comfortable."}, {"options": ["hanging-leg-raise", "hanging-straight-leg-raise", "captains-chair-straight-leg-raise"], "sets": 3, "min": 8, "max": 15, "note": "Bodyweight core, progressed by reps."}]}]}]}};
