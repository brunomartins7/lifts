...
Object.assign(ALTERNATIVES, {"barbell-bench-press": ["dumbbell-bench-press", "cable-seated-chest-press", "dumbbell-incline-bench-press"], "dumbbell-bench-press": ["barbell-bench-press", "cable-seated-chest-press", "dumbbell-incline-bench-press"], "lever-chest-press": ["barbell-bench-press", "dumbbell-bench-press"], "sled-hack-squat": ["sled-45-leg-press", "barbell-back-squat"], "sled-45-leg-press": ["sled-hack-squat", "barbell-back-squat"], "barbell-back-squat": ["sled-hack-squat", "sled-45-leg-press", "lever-leg-extension"], "cable-pulldown": ["lever-front-pulldown", "cable-lateral-pulldown-with-v-bar", "pull-up-neutral-grip"], "cable-lateral-pulldown-with-v-bar": ["cable-underhand-pulldown", "lever-front-pulldown", "cable-pulldown"], "lever-front-pulldown": ["cable-underhand-pulldown", "cable-lateral-pulldown-with-v-bar", "cable-pulldown"], "cable-one-arm-lateral-raise": ["dumbbell-lateral-raise", "cable-lateral-raise", "dumbbell-upright-row"], "cable-lateral-raise": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise"], "dumbbell-lateral-raise": ["cable-one-arm-lateral-raise", "cable-lateral-raise", "dumbbell-upright-row"], "cable-pushdown-with-rope-attachment": ["cable-triceps-pushdown-v-bar", "cable-one-arm-tricep-pushdown", "dumbbell-lying-triceps-extension"], "cable-triceps-pushdown-v-bar": ["cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown", "lever-triceps-extension"], "cable-one-arm-tricep-pushdown": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "dumbbell-lying-triceps-extension"], "lever-seated-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "sled-calf-press": ["lever-seated-calf-raise", "dumbbell-standing-calf-raise", "barbell-standing-calf-raise"], "dumbbell-standing-calf-raise": ["lever-seated-calf-raise", "sled-calf-press", "barbell-standing-calf-raise"], "barbell-romanian-deadlift": ["dumbbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-romanian-deadlift": ["barbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-stiff-leg-deadlift": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "dumbbell-incline-row": ["cable-seated-wide-grip-row", "cable-seated-row", "dumbbell-one-arm-bent-over-row"], "cable-seated-row": ["dumbbell-incline-row", "cable-seated-wide-grip-row", "dumbbell-one-arm-bent-over-row"], "lever-seated-row": ["cable-seated-row", "cable-rope-seated-row", "dumbbell-incline-row"], "dumbbell-incline-bench-press": ["barbell-incline-bench-press", "dumbbell-incline-fly", "dumbbell-bench-press"], "barbell-incline-bench-press": ["dumbbell-incline-bench-press", "dumbbell-incline-fly", "lever-incline-chest-press"], "lever-incline-chest-press": ["barbell-incline-bench-press", "dumbbell-incline-bench-press"], "cable-curl": ["dumbbell-incline-curl", "cable-one-arm-curl", "dumbbell-standing-biceps-curl"], "dumbbell-standing-biceps-curl": ["dumbbell-incline-curl", "barbell-curl", "cable-curl"], "ez-barbell-curl": ["dumbbell-standing-biceps-curl", "cable-curl", "barbell-curl"], "lever-seated-reverse-fly": ["cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "cable-cross-over-revers-fly": ["dumbbell-reverse-fly", "dumbbell-rear-lateral-raise", "cable-standing-rear-delt-row-with-rope"], "dumbbell-reverse-fly": ["dumbbell-rear-lateral-raise", "cable-cross-over-revers-fly", "cable-standing-rear-delt-row-with-rope"], "cable-kneeling-crunch": ["cable-seated-crunch", "crunch-floor", "weighted-crunch"], "weighted-crunch": ["cable-kneeling-crunch", "lever-seated-crunch"], "lever-seated-crunch": ["cable-kneeling-crunch", "weighted-crunch", "cable-seated-crunch"], "barbell-glute-bridge": ["cable-pull-through", "barbell-sumo-deadlift"], "cable-pull-through": ["barbell-glute-bridge", "barbell-sumo-deadlift"], "barbell-sumo-deadlift": ["barbell-glute-bridge", "cable-pull-through"], "dumbbell-seated-shoulder-press": ["barbell-standing-close-grip-military-press", "dumbbell-standing-overhead-press", "barbell-seated-overhead-press"], "lever-shoulder-press": ["barbell-seated-overhead-press", "dumbbell-seated-shoulder-press"], "barbell-seated-overhead-press": ["dumbbell-seated-shoulder-press", "lever-shoulder-press"], "cable-overhead-triceps-extension-rope-attachment": ["dumbbell-seated-triceps-extension", "dumbbell-standing-triceps-extension", "ez-bar-standing-french-press"], "dumbbell-seated-triceps-extension": ["dumbbell-standing-triceps-extension", "cable-overhead-triceps-extension-rope-attachment", "ez-bar-standing-french-press"], "lever-triceps-extension": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "cable-overhead-triceps-extension-rope-attachment"], "dumbbell-incline-curl": ["cable-curl", "cable-one-arm-curl", "dumbbell-standing-biceps-curl"], "cable-one-arm-curl": ["dumbbell-concentration-curl", "dumbbell-preacher-curl", "dumbbell-incline-curl"], "lever-bicep-curl": ["dumbbell-incline-curl", "cable-one-arm-curl"], "dumbbell-seated-palms-up-wrist-curl": ["barbell-wrist-curl", "cable-wrist-curl"], "barbell-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "cable-wrist-curl"], "cable-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "barbell-wrist-curl"], "cable-standing-fly": ["cable-upper-chest-crossovers", "dumbbell-fly", "lever-seated-fly"], "cable-upper-chest-crossovers": ["cable-standing-fly", "dumbbell-fly", "lever-seated-fly"], "lever-seated-fly": ["cable-standing-fly", "cable-upper-chest-crossovers"], "barbell-reverse-curl": ["cable-reverse-curl", "dumbbell-standing-reverse-curl"], "dumbbell-standing-reverse-curl": ["dumbbell-hammer-curl", "dumbbell-cross-body-hammer-curl", "barbell-reverse-curl"], "cable-reverse-curl": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl"], "pull-up": ["cable-pulldown", "cable-lateral-pulldown-with-v-bar"], "dumbbell-standing-triceps-extension": ["dumbbell-seated-triceps-extension", "cable-overhead-triceps-extension-rope-attachment", "ez-bar-standing-french-press"], "ez-bar-standing-french-press": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "dumbbell-standing-triceps-extension"], "barbell-standing-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "barbell-good-morning": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "lever-seated-leg-curl": ["lever-lying-leg-curl", "lever-kneeling-leg-curl"], "lever-lying-leg-curl": ["lever-seated-leg-curl", "lever-kneeling-leg-curl"], "lever-kneeling-leg-curl": ["lever-seated-leg-curl", "lever-lying-leg-curl"], "cable-seated-crunch": ["cable-kneeling-crunch", "crunch-floor", "lever-seated-crunch"], "lever-leg-extension": ["barbell-back-squat", "barbell-front-squat"], "barbell-front-squat": ["lever-leg-extension", "barbell-back-squat"], "cable-underhand-pulldown": ["cable-lateral-pulldown-with-v-bar", "lever-front-pulldown", "pull-up-neutral-grip"], "chin-up": ["dumbbell-one-arm-bent-over-row", "dumbbell-incline-row", "cable-lateral-pulldown-with-v-bar"], "cable-rope-seated-row": ["barbell-bent-over-row", "dumbbell-one-arm-bent-over-row", "cable-seated-row"], "lever-t-bar-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row", "cable-seated-row"], "barbell-curl": ["dumbbell-incline-curl", "dumbbell-standing-biceps-curl", "lever-preacher-curl"], "dumbbell-biceps-curl": ["ez-barbell-curl", "barbell-curl"], "hanging-leg-raise": ["hanging-straight-leg-raise", "captains-chair-straight-leg-raise"], "hanging-straight-leg-raise": ["hanging-leg-raise", "captains-chair-straight-leg-raise"], "captains-chair-straight-leg-raise": ["hanging-leg-raise", "hanging-straight-leg-raise"], "pull-up-neutral-grip": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown", "cable-pulldown"], "crunch-floor": ["cable-kneeling-crunch", "cable-seated-crunch"], "cable-hammer-curl-with-rope": ["dumbbell-hammer-curl", "dumbbell-cross-body-hammer-curl", "dumbbell-incline-curl"], "dumbbell-hammer-curl": ["dumbbell-cross-body-hammer-curl", "cable-hammer-curl-with-rope", "dumbbell-standing-reverse-curl"], "dumbbell-reverse-wrist-curl": ["barbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "barbell-reverse-wrist-curl"], "barbell-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-seated-wide-grip-row": ["dumbbell-incline-row", "cable-seated-row", "lever-t-bar-row"], "lever-high-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row"], "lever-preacher-curl": ["dumbbell-incline-curl", "barbell-curl"], "dumbbell-one-arm-bent-over-row": ["cable-rope-seated-row", "barbell-bent-over-row", "dumbbell-incline-row"], "barbell-standing-close-grip-military-press": ["dumbbell-seated-shoulder-press", "dumbbell-standing-overhead-press"], "dumbbell-standing-overhead-press": ["dumbbell-seated-shoulder-press", "barbell-standing-close-grip-military-press"], "dumbbell-upright-row": ["barbell-upright-row", "dumbbell-front-raise", "cable-one-arm-lateral-raise"], "dumbbell-lying-triceps-extension": ["barbell-lying-triceps-extension-skull-crusher", "diamond-push-up", "cable-pushdown-with-rope-attachment"], "cable-standing-rear-delt-row-with-rope": ["dumbbell-rear-lateral-raise", "cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "dumbbell-rear-lateral-raise": ["dumbbell-reverse-fly", "cable-cross-over-revers-fly", "cable-standing-rear-delt-row-with-rope"], "dumbbell-cross-body-hammer-curl": ["dumbbell-hammer-curl", "cable-hammer-curl-with-rope", "dumbbell-standing-reverse-curl"], "cable-seated-chest-press": ["barbell-bench-press", "dumbbell-bench-press"], "barbell-bent-over-row": ["cable-rope-seated-row", "dumbbell-one-arm-bent-over-row"], "dumbbell-incline-fly": ["dumbbell-incline-bench-press", "barbell-incline-bench-press"], "dumbbell-concentration-curl": ["dumbbell-preacher-curl", "cable-one-arm-curl"], "dumbbell-preacher-curl": ["dumbbell-concentration-curl", "cable-one-arm-curl"], "dumbbell-fly": ["cable-standing-fly", "cable-upper-chest-crossovers"], "barbell-lying-triceps-extension-skull-crusher": ["dumbbell-lying-triceps-extension", "diamond-push-up"], "diamond-push-up": ["dumbbell-lying-triceps-extension", "barbell-lying-triceps-extension-skull-crusher"], "barbell-upright-row": ["dumbbell-upright-row", "dumbbell-front-raise"], "dumbbell-front-raise": ["dumbbell-upright-row", "barbell-upright-row"]});
...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Flat press and back", "focus": "Mid/lower chest, lats, mid-back, front and lateral delts", "groups": [{"id": "A1", "name": "Upper body A", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "cable-seated-chest-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 180, "note": "A1: Mid/lower chest through horizontal pressing. First while fresh. Use a flat bench for the free-weight options."}, {"options": ["dumbbell-one-arm-bent-over-row", "barbell-bent-over-row", "cable-rope-seated-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "A2: Lat-focused shoulder extension. Keep elbows close and pull towards the hip or lower ribs. Support the free hand for the dumbbell row. Choose a different ID from A4."}, {"options": ["dumbbell-seated-shoulder-press", "barbell-standing-close-grip-military-press", "dumbbell-standing-overhead-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "A3: Direct front-delt pressing, with lateral-delt assistance. The row separates this from chest pressing. No leg drive."}, {"options": ["cable-rope-seated-row", "barbell-bent-over-row", "dumbbell-one-arm-bent-over-row"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 150, "note": "A4: Mid-back through scapular retraction. Let the shoulder blades move; pull towards the lower chest with elbows about 45 degrees out. Choose a different ID from A2."}, {"options": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise", "cable-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "A5: Direct lateral-delt shoulder abduction after the main lifts. Raise under control without swinging. The cable-one-arm option is unilateral."}, {"options": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "cable-one-arm-tricep-pushdown"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "A6: Lateral and medial triceps coverage through resisted elbow extension with upper arms beside the torso. All three heads contribute. Performed after pressing."}]}]}, {"id": "B", "name": "Incline press, rear delts and curls", "focus": "Upper chest, rear delts and both biceps shoulder positions", "groups": [{"id": "B1", "name": "Upper body B", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-bench-press", "barbell-incline-bench-press", "dumbbell-incline-fly"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 180, "note": "B1: Upper chest at a low incline of about 15-30 degrees. The fly retains incline chest work but removes pressing and most triceps involvement; use a lighter load."}, {"options": ["cable-standing-rear-delt-row-with-rope", "dumbbell-rear-lateral-raise", "cable-cross-over-revers-fly"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 120, "note": "B2: Rear delts through horizontal abduction; the rope row also trains scapular retractors. Keep elbows out rather than turning it into a low row. Before curls. Choose a different ID from B5."}, {"options": ["dumbbell-incline-curl", "cable-curl", "cable-one-arm-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "B3: Shoulder-extended biceps work, including the long head. Let upper arms hang behind the torso on incline curls. Both cable options must use a low pulley behind the body with upper arms behind the torso. Choose a different ID from B6."}, {"options": ["dumbbell-seated-triceps-extension", "dumbbell-standing-triceps-extension", "cable-overhead-triceps-extension-rope-attachment"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "B4: Triceps long-head work with the arms overhead, lengthening this head at the shoulder. Retain the shoulder-flexed position. Separates the rear-delt exercises."}, {"options": ["dumbbell-reverse-fly", "dumbbell-rear-lateral-raise", "cable-cross-over-revers-fly"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "B5: Further direct rear-delt horizontal abduction. Support the chest on an incline bench for dumbbell options. Choose a different ID from B2."}, {"options": ["dumbbell-concentration-curl", "dumbbell-preacher-curl", "cable-one-arm-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "B6: Shoulder-flexed supinated curls cover the short head alongside the long head. Keep the upper arm ahead of the torso. For preacher curls, support one upper arm on a securely locked incline-bench backrest. Use forward-arm support for the cable option too. Choose a different ID from B3."}]}]}, {"id": "C", "name": "Back, chest and arms", "focus": "Lats, mid-back, lateral delts, triceps and brachioradialis", "groups": [{"id": "C1", "name": "Upper body C", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-seated-row", "dumbbell-incline-row", "cable-seated-wide-grip-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "C1: Lat-focused shoulder extension. Use tucked elbows towards the lower ribs on the first two options. The wide-grip option shifts emphasis towards mid-back; A2 retains targeted lat work. Choose a different ID from C3."}, {"options": ["cable-standing-fly", "cable-upper-chest-crossovers", "dumbbell-fly"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 120, "note": "C2: Mid/lower chest through horizontal adduction. Keep dumbbell fly elbows softly bent and depth controlled. Push-ups add triceps work. Separates the two back rows. Cables rather than dumbbells, because the dumbbell version felt wrong."}, {"options": ["dumbbell-incline-row", "cable-seated-wide-grip-row", "cable-seated-row"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 150, "note": "C3: Mid-back through controlled scapular retraction, with elbows about 45-60 degrees out. Use chest support for the dumbbell row. Choose a different ID from C1."}, {"options": ["dumbbell-lying-triceps-extension", "barbell-lying-triceps-extension-skull-crusher", "diamond-push-up"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 120, "note": "C4: Additional triceps work. Lying extensions keep the upper arms raised and involve the long head. Diamond push-ups shift towards pressing; B4 retains overhead coverage. Separates back rowing from upright rows."}, {"options": ["dumbbell-upright-row", "barbell-upright-row", "dumbbell-front-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "C5: Upright rows add lateral-delt and upper-trapezius work. Use a comfortable hand width and stop elbows below shoulder height. Front raises are an anterior-delt fallback, reducing direct lateral work to A5's three sets."}, {"options": ["dumbbell-hammer-curl", "dumbbell-cross-body-hammer-curl", "cable-hammer-curl-with-rope"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "C6: Neutral-grip elbow flexion directly trains brachialis and brachioradialis, with biceps contribution. Keep wrists straight. Last so grip and elbow-flexor fatigue cannot limit rows."}]}]}]}};
...
function renderExercise(ex,dayIndex,groupId,baseId=ex.id){
  ...
  ${panel(ex.id+':tech','How to do this properly',renderTechnique(ex),!hasHistory)}
...
function panel(key,label,body,openByDefault){return`<details class="ex-panel" data-panel="${esc(key)}"${(openPanels.has(key)||(openByDefault&&!openPanels.has('!'+key)))?' open':''}><summary>${esc(label)}</summary><div class="ex-panel-body">${body}</div></details>`}
...
/* The two coached programmes, with the trade-off stated rather than implied.
   ...
   not a migration. */
const SPACING = {"chest": {"days": ["A", "B", "C"], "weeklySets": 9, "minRecoveryDays": 1, "verdict": "Three direct sets each session. Approximately 48, 48 and 72 hours between exposures on Monday, Wednesday and Friday."}, "back": {"days": ["A", "B", "C"], "weeklySets": 12, "minRecoveryDays": 1, "verdict": "Twelve main-row sets are allocated to A and C. B's rear-delt row also loads the scapular retractors, so B is not complete back rest."}, "shoulders": {"days": ["A", "B", "C"], "weeklySets": 15, "minRecoveryDays": 1, "verdict": "Defaults allocate three front-delt, six lateral-delt and six rear-delt sets. Presses and back rows add overlapping work. C5's front-raise alternative changes the allocation to six front, three lateral and six rear."}, "biceps": {"days": ["A", "B", "C"], "weeklySets": 9, "minRecoveryDays": 1, "verdict": "Six direct supinated-curl sets on B and three hammer-curl sets on C. A's rows also load the elbow flexors. Both required shoulder positions remain on B."}, "triceps": {"days": ["A", "B", "C"], "weeklySets": 9, "minRecoveryDays": 1, "verdict": "Three direct sets each session, with additional pressing work. A supplies pushdowns; B supplies overhead long-head work; C supplies additional extensions."}, "forearms": {"days": ["A", "B", "C"], "weeklySets": 3, "minRecoveryDays": 1, "verdict": "C6 supplies three deliberate brachioradialis sets, already included in the elbow-flexor allocation. Rows and curls add grip loading throughout the week. No dedicated wrist-flexor or wrist-extensor sets."}};
...
app.addEventListener('toggle',e=>{
  ...
  if(d.open){openPanels.add(d.dataset.panel);openPanels.delete('!'+d.dataset.panel)}
  else{openPanels.delete(d.dataset.panel);openPanels.add('!'+d.dataset.panel)}
},true);
...
if(!state.settings.programAppliedV7 && !state.session){
  try{
    ...
    state.settings.programAppliedV7 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
