...
Object.assign(ALTERNATIVES, {"barbell-bench-press": ["dumbbell-bench-press", "lever-chest-press"], "dumbbell-bench-press": ["barbell-bench-press", "lever-chest-press"], "lever-chest-press": ["barbell-bench-press", "dumbbell-bench-press"], "sled-hack-squat": ["sled-45-leg-press", "barbell-back-squat"], "sled-45-leg-press": ["sled-hack-squat", "barbell-back-squat"], "barbell-back-squat": ["sled-hack-squat", "sled-45-leg-press", "lever-leg-extension"], "cable-pulldown": ["lever-front-pulldown", "cable-lateral-pulldown-with-v-bar", "pull-up-neutral-grip"], "cable-lateral-pulldown-with-v-bar": ["cable-underhand-pulldown", "lever-front-pulldown", "cable-pulldown"], "lever-front-pulldown": ["cable-underhand-pulldown", "cable-lateral-pulldown-with-v-bar", "cable-pulldown"], "cable-one-arm-lateral-raise": ["dumbbell-lateral-raise", "cable-lateral-raise"], "cable-lateral-raise": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise"], "dumbbell-lateral-raise": ["cable-lateral-raise", "cable-one-arm-lateral-raise"], "cable-pushdown-with-rope-attachment": ["cable-triceps-pushdown-v-bar", "lever-triceps-extension", "cable-one-arm-tricep-pushdown"], "cable-triceps-pushdown-v-bar": ["cable-pushdown-with-rope-attachment", "lever-triceps-extension", "cable-one-arm-tricep-pushdown"], "cable-one-arm-tricep-pushdown": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "cable-pushdown-with-rope-attachment"], "lever-seated-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "sled-calf-press": ["lever-seated-calf-raise", "dumbbell-standing-calf-raise", "barbell-standing-calf-raise"], "dumbbell-standing-calf-raise": ["lever-seated-calf-raise", "sled-calf-press", "barbell-standing-calf-raise"], "barbell-romanian-deadlift": ["dumbbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-romanian-deadlift": ["barbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-stiff-leg-deadlift": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "dumbbell-incline-row": ["lever-t-bar-row", "cable-seated-wide-grip-row", "lever-high-row"], "cable-seated-row": ["cable-rope-seated-row", "lever-seated-row", "dumbbell-incline-row"], "lever-seated-row": ["cable-seated-row", "cable-rope-seated-row", "dumbbell-incline-row"], "dumbbell-incline-bench-press": ["barbell-incline-bench-press", "lever-incline-chest-press"], "barbell-incline-bench-press": ["dumbbell-incline-bench-press", "lever-incline-chest-press"], "lever-incline-chest-press": ["barbell-incline-bench-press", "dumbbell-incline-bench-press"], "cable-curl": ["dumbbell-standing-biceps-curl", "ez-barbell-curl", "dumbbell-incline-curl"], "dumbbell-standing-biceps-curl": ["cable-curl", "ez-barbell-curl", "dumbbell-incline-curl"], "ez-barbell-curl": ["dumbbell-standing-biceps-curl", "cable-curl", "barbell-curl"], "lever-seated-reverse-fly": ["cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "cable-cross-over-revers-fly": ["lever-seated-reverse-fly", "dumbbell-reverse-fly"], "dumbbell-reverse-fly": ["cable-cross-over-revers-fly", "lever-seated-reverse-fly"], "cable-kneeling-crunch": ["cable-seated-crunch", "crunch-floor", "weighted-crunch"], "weighted-crunch": ["cable-kneeling-crunch", "lever-seated-crunch"], "lever-seated-crunch": ["cable-kneeling-crunch", "weighted-crunch", "cable-seated-crunch"], "barbell-glute-bridge": ["cable-pull-through", "barbell-sumo-deadlift"], "cable-pull-through": ["barbell-glute-bridge", "barbell-sumo-deadlift"], "barbell-sumo-deadlift": ["barbell-glute-bridge", "cable-pull-through"], "dumbbell-seated-shoulder-press": ["barbell-seated-overhead-press", "lever-shoulder-press"], "lever-shoulder-press": ["barbell-seated-overhead-press", "dumbbell-seated-shoulder-press"], "barbell-seated-overhead-press": ["dumbbell-seated-shoulder-press", "lever-shoulder-press"], "cable-overhead-triceps-extension-rope-attachment": ["dumbbell-seated-triceps-extension", "ez-bar-standing-french-press", "cable-one-arm-tricep-pushdown"], "dumbbell-seated-triceps-extension": ["cable-overhead-triceps-extension-rope-attachment", "ez-bar-standing-french-press", "cable-one-arm-tricep-pushdown"], "lever-triceps-extension": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "cable-overhead-triceps-extension-rope-attachment"], "dumbbell-incline-curl": ["barbell-curl", "lever-preacher-curl", "cable-hammer-curl-with-rope"], "cable-one-arm-curl": ["dumbbell-incline-curl", "lever-bicep-curl"], "lever-bicep-curl": ["dumbbell-incline-curl", "cable-one-arm-curl"], "dumbbell-seated-palms-up-wrist-curl": ["barbell-wrist-curl", "cable-wrist-curl"], "barbell-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "cable-wrist-curl"], "cable-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "barbell-wrist-curl"], "cable-standing-fly": ["cable-upper-chest-crossovers", "lever-seated-fly"], "cable-upper-chest-crossovers": ["cable-standing-fly", "lever-seated-fly"], "lever-seated-fly": ["cable-standing-fly", "cable-upper-chest-crossovers"], "barbell-reverse-curl": ["cable-reverse-curl", "dumbbell-standing-reverse-curl"], "dumbbell-standing-reverse-curl": ["barbell-reverse-curl", "cable-reverse-curl"], "cable-reverse-curl": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl"], "pull-up": ["cable-pulldown", "cable-lateral-pulldown-with-v-bar"], "dumbbell-standing-triceps-extension": ["cable-overhead-triceps-extension-rope-attachment", "ez-bar-standing-french-press", "dumbbell-seated-triceps-extension"], "ez-bar-standing-french-press": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "dumbbell-standing-triceps-extension"], "barbell-standing-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "barbell-good-morning": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "lever-seated-leg-curl": ["lever-lying-leg-curl", "lever-kneeling-leg-curl"], "lever-lying-leg-curl": ["lever-seated-leg-curl", "lever-kneeling-leg-curl"], "lever-kneeling-leg-curl": ["lever-seated-leg-curl", "lever-lying-leg-curl"], "cable-seated-crunch": ["cable-kneeling-crunch", "crunch-floor", "lever-seated-crunch"], "lever-leg-extension": ["barbell-back-squat", "barbell-front-squat"], "barbell-front-squat": ["lever-leg-extension", "barbell-back-squat"], "cable-underhand-pulldown": ["cable-lateral-pulldown-with-v-bar", "lever-front-pulldown", "pull-up-neutral-grip"], "chin-up": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown"], "cable-rope-seated-row": ["cable-seated-row", "lever-seated-row", "lever-t-bar-row"], "lever-t-bar-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row", "cable-seated-row"], "barbell-curl": ["dumbbell-incline-curl", "lever-preacher-curl", "ez-barbell-curl"], "dumbbell-biceps-curl": ["ez-barbell-curl", "barbell-curl"], "hanging-leg-raise": ["hanging-straight-leg-raise", "captains-chair-straight-leg-raise"], "hanging-straight-leg-raise": ["hanging-leg-raise", "captains-chair-straight-leg-raise"], "captains-chair-straight-leg-raise": ["hanging-leg-raise", "hanging-straight-leg-raise"], "pull-up-neutral-grip": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown", "cable-pulldown"], "crunch-floor": ["cable-kneeling-crunch", "cable-seated-crunch"], "cable-hammer-curl-with-rope": ["dumbbell-incline-curl", "dumbbell-hammer-curl"], "dumbbell-hammer-curl": ["dumbbell-incline-curl", "cable-hammer-curl-with-rope"], "dumbbell-reverse-wrist-curl": ["barbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "barbell-reverse-wrist-curl"], "barbell-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-seated-wide-grip-row": ["lever-t-bar-row", "dumbbell-incline-row", "lever-high-row"], "lever-high-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row"], "lever-preacher-curl": ["dumbbell-incline-curl", "barbell-curl"]});
...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Chest, lats and arms", "focus": "Flat pressing, vertical pulling, lateral delts and direct arm and wrist-flexor work.", "groups": [{"id": "A1", "name": "Full upper", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "lever-chest-press"], "sets": 4, "min": 8, "max": 10, "rir": 2, "rest": 150, "note": "Primary flat chest work while pressing strength is fresh. It is followed by a vertical pull, never by incline pressing."}, {"options": ["cable-pulldown", "lever-front-pulldown", "cable-lateral-pulldown-with-v-bar"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 120, "note": "Loadable vertical pulling for four direct lat sets. The cable and lever options suit a near-novice better than strict bodyweight pulling."}, {"options": ["cable-lateral-raise", "dumbbell-lateral-raise", "cable-one-arm-lateral-raise"], "sets": 4, "min": 12, "max": 15, "rir": 2, "rest": 75, "note": "First of two weekly lateral-delt exposures. It is late because it has low systemic and technical demand."}, {"options": ["dumbbell-standing-biceps-curl", "cable-curl", "ez-barbell-curl"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 90, "note": "Direct biceps work after the main pulling movement, with enough volume to correct the previous under-dose."}, {"options": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "lever-triceps-extension"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 90, "note": "First direct triceps exposure after pressing and pulling. Four sets are supported by the additional indirect triceps work from chest pressing."}, {"options": ["dumbbell-seated-palms-up-wrist-curl", "barbell-wrist-curl", "cable-wrist-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "Direct wrist flexion for the forearm flexors. It is last so grip fatigue does not reduce the quality of earlier work."}]}]}, {"id": "B", "name": "Shoulders, mid-back and arms", "focus": "Front-delt priority, horizontal pulling, rear delts and direct wrist-extension work.", "groups": [{"id": "B1", "name": "Full upper", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-seated-overhead-press", "dumbbell-seated-shoulder-press", "lever-shoulder-press"], "sets": 3, "min": 8, "max": 10, "rir": 2, "rest": 150, "note": "The direct front-delt work opens the session so pressing skill and output are not limited by prior fatigue."}, {"options": ["cable-seated-row", "cable-rope-seated-row", "lever-seated-row"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 120, "note": "Four direct mid-back sets after the overhead press. This is the only row in the session."}, {"options": ["lever-seated-reverse-fly", "dumbbell-reverse-fly", "cable-cross-over-revers-fly"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 75, "note": "First of two weekly rear-delt exposures. It follows the row so rear-delt isolation does not reduce upper-back performance."}, {"options": ["dumbbell-incline-curl", "barbell-curl", "lever-preacher-curl"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 90, "note": "Second weekly direct biceps exposure using a different curl profile from Session A."}, {"options": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "ez-bar-standing-french-press"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 90, "note": "Second direct triceps exposure, using an overhead position to complement the pushdown pattern."}, {"options": ["dumbbell-reverse-wrist-curl", "barbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "Direct wrist extension for the forearm extensors. It is last to avoid compromising row and curl grip."}]}]}, {"id": "C", "name": "Incline chest, back and delts", "focus": "Incline pressing, loadable vertical pulling, mid-back work, lateral and rear delts, and pronated-grip elbow flexion.", "groups": [{"id": "C1", "name": "Full upper", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-incline-bench-press", "dumbbell-incline-bench-press", "lever-incline-chest-press"], "sets": 4, "min": 8, "max": 10, "rir": 2, "rest": 150, "note": "Second weekly chest exposure. It is not immediately preceded by a flat bench, and the session uses incline pressing without creating consecutive pressing fatigue."}, {"options": ["cable-underhand-pulldown", "cable-lateral-pulldown-with-v-bar", "lever-front-pulldown"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 120, "note": "Second weekly lat exposure using only loadable cable or lever options."}, {"options": ["lever-t-bar-row", "cable-seated-wide-grip-row", "dumbbell-incline-row"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 120, "note": "Second weekly mid-back exposure after the vertical pull. It is the only row in the session, so rows are never consecutive."}, {"options": ["dumbbell-lateral-raise", "cable-lateral-raise", "cable-one-arm-lateral-raise"], "sets": 4, "min": 12, "max": 15, "rir": 2, "rest": 75, "note": "Second weekly lateral-delt exposure, bringing direct lateral-delt volume to eight sets."}, {"options": ["cable-cross-over-revers-fly", "lever-seated-reverse-fly", "dumbbell-reverse-fly"], "sets": 4, "min": 10, "max": 12, "rir": 2, "rest": 75, "note": "Second weekly rear-delt exposure, bringing direct rear-delt volume to eight sets."}, {"options": ["barbell-reverse-curl", "cable-reverse-curl", "dumbbell-standing-reverse-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "Pronated-grip elbow flexion for brachioradialis and the forearm extensors. It completes the three-part forearm rotation."}]}]}]}};
...
/* The two coached programmes, with the trade-off stated rather than implied.
   ...
   not a migration. */
const SPACING = {"chest": {"days": ["A", "C"], "weeklySets": 8, "minRecoveryDays": 3, "verdict": "Four direct sets in A and C. A to C provides at least 96 hours, and C to the next A provides at least 72 hours."}, "lats": {"days": ["A", "C"], "weeklySets": 8, "minRecoveryDays": 3, "verdict": "Four direct sets in A and C. The total weekly lat volume stays inside the near-novice range."}, "mid-back": {"days": ["B", "C"], "weeklySets": 8, "minRecoveryDays": 2, "verdict": "Four direct row sets in B and C with 48 hours between them. Each session contains only one row slot."}, "front delts": {"days": ["B"], "weeklySets": 3, "minRecoveryDays": 7, "verdict": "Three direct overhead-press sets. Chest pressing in A and C supplies additional indirect front-delt work."}, "lateral delts": {"days": ["A", "C"], "weeklySets": 8, "minRecoveryDays": 3, "verdict": "Four direct sets in A and C, with at least 72 hours across the weekly cycle. This corrects the previous once-weekly exposure."}, "rear delts": {"days": ["B", "C"], "weeklySets": 8, "minRecoveryDays": 2, "verdict": "Four direct sets in B and C, with 48 hours between them. Rows add indirect rear-delt work."}, "biceps": {"days": ["A", "B"], "weeklySets": 8, "minRecoveryDays": 2, "verdict": "Four direct sets in A and B with 48 hours between them, plus indirect elbow-flexion work from all vertical pulls and rows."}, "triceps": {"days": ["A", "B"], "weeklySets": 8, "minRecoveryDays": 2, "verdict": "Four direct sets in A and B with 48 hours between them, plus indirect triceps work from all pressing. The third direct triceps slot was exchanged for the second rear-delt exposure."}, "forearms": {"days": ["A", "B", "C"], "weeklySets": 9, "minRecoveryDays": 2, "verdict": "A trains wrist flexion, B trains wrist extension and C trains pronated-grip elbow flexion. Each function repeats weekly, while the overall forearms receive work every session."}};
...
if(!state.settings.programAppliedV5 && !state.session){
  try{
    ...
    state.settings.programAppliedV5 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
