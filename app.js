...
if(!state.settings.programAppliedV13 && !state.session){
  try{
    ...
    state.settings.programAppliedV13 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
