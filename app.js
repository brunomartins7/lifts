...
function renderPresetCard(){
  ...
  ${row('withLegs','Full body over three days','Six exercises a day, eighteen slots, every muscle group trained.','Back 9 · Delts 9 · Chest 6 · Quads 6 · Hamstrings 6 · Calves 6 · Triceps 4 · Core 3 · Biceps 2 direct sets per week',true)}
  ...
  <div class="small faint" style="margin-top:11px">The full-body version is the better program, and the audit rebuilt it: lateral delts went from 2 direct sets a week to 6, knee flexion and knee extension from nothing to 3 each, and both calf slots now work with a straight knee so the gastrocnemius is actually loaded. It pays for that with less chest volume, 2 direct biceps sets, and no dedicated shoulder press — pressing already supplies the front delt. The upper-only version is the better version of what you used to do, and still trains no legs at all.</div></div>`;
}
