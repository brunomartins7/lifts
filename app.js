...
Object.assign(ALTERNATIVES, {"barbell-bench-press": ["push-up", "cable-seated-chest-press", "dumbbell-bench-press"], "dumbbell-bench-press": ["dumbbell-fly", "cable-standing-fly", "barbell-bench-press"], "lever-chest-press": ["barbell-bench-press", "dumbbell-bench-press"], "sled-hack-squat": ["sled-45-leg-press", "barbell-back-squat"], "sled-45-leg-press": ["sled-hack-squat", "barbell-back-squat"], "barbell-back-squat": ["sled-hack-squat", "sled-45-leg-press", "lever-leg-extension"], "cable-pulldown": ["lever-front-pulldown", "cable-lateral-pulldown-with-v-bar", "pull-up-neutral-grip"], "cable-lateral-pulldown-with-v-bar": ["cable-underhand-pulldown", "lever-front-pulldown", "cable-pulldown"], "lever-front-pulldown": ["cable-underhand-pulldown", "cable-lateral-pulldown-with-v-bar", "cable-pulldown"], "cable-one-arm-lateral-raise": ["cable-lateral-raise", "dumbbell-lateral-raise", "dumbbell-upright-row"], "cable-lateral-raise": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise"], "dumbbell-lateral-raise": ["cable-lateral-raise", "cable-one-arm-lateral-raise", "dumbbell-upright-row"], "cable-pushdown-with-rope-attachment": ["cable-triceps-pushdown-v-bar", "cable-one-arm-tricep-pushdown", "cable-overhead-triceps-extension-rope-attachment"], "cable-triceps-pushdown-v-bar": ["cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown", "lever-triceps-extension"], "cable-one-arm-tricep-pushdown": ["cable-triceps-pushdown-v-bar", "cable-pushdown-with-rope-attachment", "dumbbell-lying-triceps-extension"], "lever-seated-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "sled-calf-press": ["lever-seated-calf-raise", "dumbbell-standing-calf-raise", "barbell-standing-calf-raise"], "dumbbell-standing-calf-raise": ["lever-seated-calf-raise", "sled-calf-press", "barbell-standing-calf-raise"], "barbell-romanian-deadlift": ["dumbbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-romanian-deadlift": ["barbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-stiff-leg-deadlift": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "dumbbell-incline-row": ["cable-straight-arm-pulldown", "dumbbell-pullover", "cable-seated-wide-grip-row"], "cable-seated-row": ["cable-rope-seated-row", "dumbbell-one-arm-bent-over-row", "cable-seated-wide-grip-row"], "lever-seated-row": ["cable-seated-row", "cable-rope-seated-row", "dumbbell-incline-row"], "dumbbell-incline-bench-press": ["barbell-incline-bench-press", "dumbbell-incline-fly", "dumbbell-bench-press"], "barbell-incline-bench-press": ["dumbbell-incline-bench-press", "dumbbell-incline-fly", "barbell-bench-press"], "lever-incline-chest-press": ["barbell-incline-bench-press", "dumbbell-incline-bench-press"], "cable-curl": ["dumbbell-standing-biceps-curl", "barbell-curl", "dumbbell-incline-curl"], "dumbbell-standing-biceps-curl": ["barbell-curl", "cable-curl", "dumbbell-incline-curl"], "ez-barbell-curl": ["dumbbell-preacher-curl", "barbell-preacher-curl", "dumbbell-standing-biceps-curl"], "lever-seated-reverse-fly": ["cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "cable-cross-over-revers-fly": ["cable-standing-rear-delt-row-with-rope", "dumbbell-rear-lateral-raise", "dumbbell-reverse-fly"], "dumbbell-reverse-fly": ["dumbbell-rear-lateral-raise", "cable-cross-over-revers-fly", "cable-standing-rear-delt-row-with-rope"], "cable-kneeling-crunch": ["cable-seated-crunch", "crunch-floor", "weighted-crunch"], "weighted-crunch": ["cable-kneeling-crunch", "lever-seated-crunch"], "lever-seated-crunch": ["cable-kneeling-crunch", "weighted-crunch", "cable-seated-crunch"], "barbell-glute-bridge": ["cable-pull-through", "barbell-sumo-deadlift"], "cable-pull-through": ["barbell-glute-bridge", "barbell-sumo-deadlift"], "barbell-sumo-deadlift": ["barbell-glute-bridge", "cable-pull-through"], "dumbbell-seated-shoulder-press": ["barbell-seated-overhead-press", "dumbbell-standing-overhead-press", "barbell-standing-close-grip-military-press"], "lever-shoulder-press": ["barbell-seated-overhead-press", "dumbbell-seated-shoulder-press"], "barbell-seated-overhead-press": ["dumbbell-seated-shoulder-press", "dumbbell-standing-overhead-press", "lever-shoulder-press"], "cable-overhead-triceps-extension-rope-attachment": ["dumbbell-standing-triceps-extension", "dumbbell-seated-triceps-extension", "cable-pushdown-with-rope-attachment"], "dumbbell-seated-triceps-extension": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-standing-triceps-extension", "cable-pushdown-with-rope-attachment"], "lever-triceps-extension": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "cable-overhead-triceps-extension-rope-attachment"], "dumbbell-incline-curl": ["dumbbell-concentration-curl", "cable-one-arm-curl", "cable-curl"], "cable-one-arm-curl": ["dumbbell-incline-curl", "dumbbell-concentration-curl", "cable-curl"], "lever-bicep-curl": ["dumbbell-incline-curl", "cable-one-arm-curl"], "dumbbell-seated-palms-up-wrist-curl": ["barbell-wrist-curl", "cable-wrist-curl"], "barbell-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "cable-wrist-curl"], "cable-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "barbell-wrist-curl"], "cable-standing-fly": ["dumbbell-bench-press", "dumbbell-fly", "cable-upper-chest-crossovers"], "cable-upper-chest-crossovers": ["cable-standing-fly", "dumbbell-fly", "lever-seated-fly"], "lever-seated-fly": ["cable-standing-fly", "cable-upper-chest-crossovers"], "barbell-reverse-curl": ["dumbbell-standing-reverse-curl", "cable-reverse-curl"], "dumbbell-standing-reverse-curl": ["barbell-reverse-curl", "cable-reverse-curl", "dumbbell-hammer-curl"], "cable-reverse-curl": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl"], "pull-up": ["cable-pulldown", "cable-lateral-pulldown-with-v-bar"], "dumbbell-standing-triceps-extension": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "ez-bar-standing-french-press"], "ez-bar-standing-french-press": ["dumbbell-standing-triceps-extension", "dumbbell-seated-triceps-extension", "cable-overhead-triceps-extension-rope-attachment"], "barbell-standing-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "barbell-good-morning": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "lever-seated-leg-curl": ["lever-lying-leg-curl", "lever-kneeling-leg-curl"], "lever-lying-leg-curl": ["lever-seated-leg-curl", "lever-kneeling-leg-curl"], "lever-kneeling-leg-curl": ["lever-seated-leg-curl", "lever-lying-leg-curl"], "cable-seated-crunch": ["cable-kneeling-crunch", "crunch-floor", "lever-seated-crunch"], "lever-leg-extension": ["barbell-back-squat", "barbell-front-squat"], "barbell-front-squat": ["lever-leg-extension", "barbell-back-squat"], "cable-underhand-pulldown": ["cable-lateral-pulldown-with-v-bar", "lever-front-pulldown", "pull-up-neutral-grip"], "chin-up": ["dumbbell-one-arm-bent-over-row", "dumbbell-incline-row", "cable-lateral-pulldown-with-v-bar"], "cable-rope-seated-row": ["cable-seated-row", "dumbbell-one-arm-bent-over-row", "barbell-bent-over-row"], "lever-t-bar-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row", "cable-seated-row"], "barbell-curl": ["dumbbell-standing-biceps-curl", "cable-curl", "dumbbell-incline-curl"], "dumbbell-biceps-curl": ["ez-barbell-curl", "barbell-curl"], "hanging-leg-raise": ["hanging-straight-leg-raise", "captains-chair-straight-leg-raise"], "hanging-straight-leg-raise": ["hanging-leg-raise", "captains-chair-straight-leg-raise"], "captains-chair-straight-leg-raise": ["hanging-leg-raise", "hanging-straight-leg-raise"], "pull-up-neutral-grip": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown", "cable-pulldown"], "crunch-floor": ["cable-kneeling-crunch", "cable-seated-crunch"], "cable-hammer-curl-with-rope": ["dumbbell-cross-body-hammer-curl", "dumbbell-hammer-curl", "dumbbell-incline-curl"], "dumbbell-hammer-curl": ["dumbbell-cross-body-hammer-curl", "cable-hammer-curl-with-rope", "dumbbell-standing-reverse-curl"], "dumbbell-reverse-wrist-curl": ["barbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "barbell-reverse-wrist-curl"], "barbell-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-seated-wide-grip-row": ["dumbbell-incline-row", "barbell-pendlay-row", "cable-seated-row"], "lever-high-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row"], "lever-preacher-curl": ["dumbbell-incline-curl", "barbell-curl"], "dumbbell-one-arm-bent-over-row": ["cable-seated-row", "cable-rope-seated-row", "barbell-bent-over-row"], "barbell-standing-close-grip-military-press": ["dumbbell-seated-shoulder-press", "dumbbell-standing-overhead-press"], "dumbbell-standing-overhead-press": ["dumbbell-seated-shoulder-press", "barbell-seated-overhead-press", "barbell-standing-close-grip-military-press"], "dumbbell-upright-row": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise", "barbell-upright-row"], "dumbbell-lying-triceps-extension": ["barbell-lying-triceps-extension-skull-crusher", "cable-kickback", "diamond-push-up"], "cable-standing-rear-delt-row-with-rope": ["cable-cross-over-revers-fly", "dumbbell-rear-lateral-raise", "dumbbell-reverse-fly"], "dumbbell-rear-lateral-raise": ["cable-standing-rear-delt-row-with-rope", "cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "dumbbell-cross-body-hammer-curl": ["dumbbell-hammer-curl", "cable-hammer-curl-with-rope", "dumbbell-standing-reverse-curl"], "cable-seated-chest-press": ["barbell-bench-press", "push-up", "dumbbell-bench-press"], "barbell-bent-over-row": ["dumbbell-one-arm-bent-over-row", "cable-rope-seated-row", "barbell-pendlay-row"], "dumbbell-incline-fly": ["dumbbell-incline-bench-press", "barbell-incline-bench-press"], "dumbbell-concentration-curl": ["dumbbell-incline-curl", "cable-one-arm-curl", "dumbbell-preacher-curl"], "dumbbell-preacher-curl": ["barbell-preacher-curl", "ez-barbell-curl", "dumbbell-concentration-curl"], "dumbbell-fly": ["dumbbell-bench-press", "cable-standing-fly", "cable-upper-chest-crossovers"], "barbell-lying-triceps-extension-skull-crusher": ["dumbbell-lying-triceps-extension", "cable-kickback", "diamond-push-up"], "diamond-push-up": ["dumbbell-lying-triceps-extension", "barbell-lying-triceps-extension-skull-crusher"], "barbell-upright-row": ["dumbbell-upright-row", "dumbbell-front-raise"], "dumbbell-front-raise": ["dumbbell-upright-row", "barbell-upright-row"], "barbell-pendlay-row": ["dumbbell-incline-row", "cable-seated-wide-grip-row", "barbell-bent-over-row"], "barbell-preacher-curl": ["dumbbell-preacher-curl", "ez-barbell-curl"], "push-up": ["barbell-bench-press", "cable-seated-chest-press"], "cable-kickback": ["barbell-lying-triceps-extension-skull-crusher", "dumbbell-lying-triceps-extension"], "cable-straight-arm-pulldown": ["dumbbell-pullover", "dumbbell-incline-row"], "dumbbell-pullover": ["cable-straight-arm-pulldown", "dumbbell-incline-row"]});
...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Chest and triceps", "focus": "Chest and triceps priority; lateral and rear delts.", "groups": [{"id": "A1", "name": "Press and rear delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "push-up", "cable-seated-chest-press"], "sets": 3, "min": 6, "max": 10, "rir": 2, "rest": 180, "note": "Primary chest exercise goes first for fresh technique and progression. Use a load or push-up difficulty that fits the range."}, {"options": ["cable-cross-over-revers-fly", "dumbbell-rear-lateral-raise", "cable-standing-rear-delt-row-with-rope"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Restores the rear-delt exposure displaced by skull crushers. Comes after pressing; select a different exercise from B's rear-delt slot."}]}, {"id": "A2", "name": "Incline and lateral delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-bench-press", "barbell-incline-bench-press", "dumbbell-incline-fly"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 180, "note": "Adds an inclined chest angle while chest remains the priority. Expect less load after benching; keep the incline modest."}, {"options": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise", "cable-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Direct lateral-delt work after chest pressing. Default to dumbbells here and cables on B; cable aliases do not count as different exercises."}]}, {"id": "A3", "name": "Triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-standing-triceps-extension", "dumbbell-seated-triceps-extension"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 120, "note": "Keeps one overhead extension in the week. Deltoid work separates this from pressing; perform it before the simpler pushdown."}, {"options": ["cable-triceps-pushdown-v-bar", "cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Stable triceps work finishes the session. Adjust the load for accumulated pressing and extension fatigue."}]}]}, {"id": "B", "name": "Back and biceps", "focus": "Back and biceps priority; second lateral- and rear-delt exposures.", "groups": [{"id": "B1", "name": "Rows", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-one-arm-bent-over-row", "barbell-bent-over-row", "cable-rope-seated-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Priority back exercise. Support the default one-arm row on the bench and keep the elbow relatively close to the torso. Complete both sides before the full rest."}, {"options": ["cable-lateral-raise", "dumbbell-lateral-raise", "cable-one-arm-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Second lateral-delt exposure separates the two main rows without tiring the elbow flexors. Must differ from A's lateral raise."}]}, {"id": "B2", "name": "Pull and curls", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-straight-arm-pulldown", "dumbbell-pullover", "dumbbell-incline-row"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "The only overhead pulling pattern available without a bar, and the closest thing to a pull-up he can train. High pulley, elbows nearly straight, drive down to the thighs."}, {"options": ["dumbbell-standing-biceps-curl", "barbell-curl", "cable-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Supinated curl after the main back work. Also prevents the chest-supported and rope rear-delt rows occurring back to back."}]}, {"id": "B3", "name": "Rear delts and arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-standing-rear-delt-row-with-rope", "cable-cross-over-revers-fly", "dumbbell-rear-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Second direct rear-delt exposure. Keep the rope movement light and controlled with elbows out; it is rear-delt work, not another heavy lat row. Must differ from A."}, {"options": ["dumbbell-cross-body-hammer-curl", "dumbbell-hammer-curl", "cable-hammer-curl-with-rope"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Neutral-grip elbow-flexor and brachioradialis work finishes the session so grip fatigue cannot compromise the main rows."}]}]}, {"id": "C", "name": "Shoulders and upper-body top-ups", "focus": "Shoulder-press priority; smaller chest, back and arm exposures.", "groups": [{"id": "C1", "name": "Press and row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-seated-shoulder-press", "barbell-seated-overhead-press", "dumbbell-standing-overhead-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 180, "note": "The week's dedicated shoulder press goes first. Use strict repetitions without leg drive."}, {"options": ["cable-seated-row", "cable-rope-seated-row", "dumbbell-one-arm-bent-over-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Three-set back top-up and a break between presses. Keep elbows relatively close and avoid torso heaving. Select an exercise not used on B."}]}, {"id": "C2", "name": "Chest and triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-bench-press", "dumbbell-fly", "cable-standing-fly"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 180, "note": "Second weekly chest exposure. Chest is secondary today; adjust load for earlier shoulder pressing. Fly alternatives reduce secondary triceps work."}, {"options": ["barbell-lying-triceps-extension-skull-crusher", "dumbbell-lying-triceps-extension", "cable-kickback"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 120, "note": "Requested skull-crusher substitution, after all pressing. Start light and lower under control; alternatives are available if the barbell version is uncomfortable."}]}, {"id": "C3", "name": "Arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-curl", "dumbbell-concentration-curl", "cable-one-arm-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Second biceps exposure after rowing. The incline curl is a simple supported variation using the existing bench, replacing the retired fourth main row."}, {"options": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl", "cable-reverse-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Forearm emphasis last. Keep wrists steady and use a light enough load to avoid swinging; accumulated elbow-flexor fatigue is expected."}]}]}]}};
...
for(const b of BANK){ const f=BANK_FIX[b.id]; if(f) Object.assign(b,f); }
...
if(!state.settings.programAppliedV11 && !state.session){
  try{
    ...
    state.settings.programAppliedV11 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
