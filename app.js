...
Object.assign(ALTERNATIVES, {"barbell-bench-press": ["dumbbell-bench-press", "dumbbell-incline-bench-press", "lever-chest-press"], "dumbbell-bench-press": ["barbell-bench-press", "dumbbell-incline-bench-press", "lever-chest-press"], "lever-chest-press": ["barbell-bench-press", "dumbbell-bench-press"], "sled-hack-squat": ["sled-45-leg-press", "barbell-back-squat"], "sled-45-leg-press": ["sled-hack-squat", "barbell-back-squat"], "barbell-back-squat": ["sled-hack-squat", "sled-45-leg-press", "lever-leg-extension"], "cable-pulldown": ["lever-front-pulldown", "cable-lateral-pulldown-with-v-bar", "pull-up-neutral-grip"], "cable-lateral-pulldown-with-v-bar": ["cable-underhand-pulldown", "lever-front-pulldown", "cable-pulldown"], "lever-front-pulldown": ["cable-underhand-pulldown", "cable-lateral-pulldown-with-v-bar", "cable-pulldown"], "cable-one-arm-lateral-raise": ["dumbbell-lateral-raise", "dumbbell-upright-row", "cable-lateral-raise"], "cable-lateral-raise": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise"], "dumbbell-lateral-raise": ["cable-one-arm-lateral-raise", "dumbbell-upright-row", "cable-lateral-raise"], "cable-pushdown-with-rope-attachment": ["dumbbell-lying-triceps-extension", "cable-one-arm-tricep-pushdown", "cable-triceps-pushdown-v-bar"], "cable-triceps-pushdown-v-bar": ["cable-pushdown-with-rope-attachment", "lever-triceps-extension", "cable-one-arm-tricep-pushdown"], "cable-one-arm-tricep-pushdown": ["cable-pushdown-with-rope-attachment", "dumbbell-lying-triceps-extension", "cable-overhead-triceps-extension-rope-attachment"], "lever-seated-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "sled-calf-press": ["lever-seated-calf-raise", "dumbbell-standing-calf-raise", "barbell-standing-calf-raise"], "dumbbell-standing-calf-raise": ["lever-seated-calf-raise", "sled-calf-press", "barbell-standing-calf-raise"], "barbell-romanian-deadlift": ["dumbbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-romanian-deadlift": ["barbell-romanian-deadlift", "dumbbell-stiff-leg-deadlift", "barbell-good-morning"], "dumbbell-stiff-leg-deadlift": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "dumbbell-incline-row": ["cable-seated-row", "dumbbell-one-arm-bent-over-row", "chin-up"], "cable-seated-row": ["dumbbell-incline-row", "dumbbell-one-arm-bent-over-row", "cable-rope-seated-row"], "lever-seated-row": ["cable-seated-row", "cable-rope-seated-row", "dumbbell-incline-row"], "dumbbell-incline-bench-press": ["dumbbell-bench-press", "barbell-bench-press", "barbell-incline-bench-press"], "barbell-incline-bench-press": ["dumbbell-incline-bench-press", "lever-incline-chest-press"], "lever-incline-chest-press": ["barbell-incline-bench-press", "dumbbell-incline-bench-press"], "cable-curl": ["dumbbell-standing-biceps-curl", "ez-barbell-curl", "dumbbell-incline-curl"], "dumbbell-standing-biceps-curl": ["dumbbell-incline-curl", "barbell-curl", "cable-curl"], "ez-barbell-curl": ["dumbbell-standing-biceps-curl", "cable-curl", "barbell-curl"], "lever-seated-reverse-fly": ["cable-cross-over-revers-fly", "dumbbell-reverse-fly"], "cable-cross-over-revers-fly": ["lever-seated-reverse-fly", "dumbbell-reverse-fly"], "dumbbell-reverse-fly": ["cable-standing-rear-delt-row-with-rope", "dumbbell-rear-lateral-raise", "cable-cross-over-revers-fly"], "cable-kneeling-crunch": ["cable-seated-crunch", "crunch-floor", "weighted-crunch"], "weighted-crunch": ["cable-kneeling-crunch", "lever-seated-crunch"], "lever-seated-crunch": ["cable-kneeling-crunch", "weighted-crunch", "cable-seated-crunch"], "barbell-glute-bridge": ["cable-pull-through", "barbell-sumo-deadlift"], "cable-pull-through": ["barbell-glute-bridge", "barbell-sumo-deadlift"], "barbell-sumo-deadlift": ["barbell-glute-bridge", "cable-pull-through"], "dumbbell-seated-shoulder-press": ["barbell-standing-close-grip-military-press", "dumbbell-standing-overhead-press", "barbell-seated-overhead-press"], "lever-shoulder-press": ["barbell-seated-overhead-press", "dumbbell-seated-shoulder-press"], "barbell-seated-overhead-press": ["dumbbell-seated-shoulder-press", "lever-shoulder-press"], "cable-overhead-triceps-extension-rope-attachment": ["dumbbell-seated-triceps-extension", "dumbbell-standing-triceps-extension", "ez-bar-standing-french-press"], "dumbbell-seated-triceps-extension": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-standing-triceps-extension", "ez-bar-standing-french-press"], "lever-triceps-extension": ["cable-pushdown-with-rope-attachment", "cable-triceps-pushdown-v-bar", "cable-overhead-triceps-extension-rope-attachment"], "dumbbell-incline-curl": ["dumbbell-standing-biceps-curl", "barbell-curl", "lever-preacher-curl"], "cable-one-arm-curl": ["dumbbell-incline-curl", "lever-bicep-curl"], "lever-bicep-curl": ["dumbbell-incline-curl", "cable-one-arm-curl"], "dumbbell-seated-palms-up-wrist-curl": ["barbell-wrist-curl", "cable-wrist-curl"], "barbell-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "cable-wrist-curl"], "cable-wrist-curl": ["dumbbell-seated-palms-up-wrist-curl", "barbell-wrist-curl"], "cable-standing-fly": ["cable-upper-chest-crossovers", "lever-seated-fly"], "cable-upper-chest-crossovers": ["cable-standing-fly", "lever-seated-fly"], "lever-seated-fly": ["cable-standing-fly", "cable-upper-chest-crossovers"], "barbell-reverse-curl": ["cable-reverse-curl", "dumbbell-standing-reverse-curl"], "dumbbell-standing-reverse-curl": ["dumbbell-hammer-curl", "dumbbell-cross-body-hammer-curl", "barbell-reverse-curl"], "cable-reverse-curl": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl"], "pull-up": ["cable-pulldown", "cable-lateral-pulldown-with-v-bar"], "dumbbell-standing-triceps-extension": ["dumbbell-seated-triceps-extension", "cable-overhead-triceps-extension-rope-attachment", "ez-bar-standing-french-press"], "ez-bar-standing-french-press": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "dumbbell-standing-triceps-extension"], "barbell-standing-calf-raise": ["sled-calf-press", "dumbbell-standing-calf-raise"], "barbell-good-morning": ["barbell-romanian-deadlift", "dumbbell-romanian-deadlift"], "lever-seated-leg-curl": ["lever-lying-leg-curl", "lever-kneeling-leg-curl"], "lever-lying-leg-curl": ["lever-seated-leg-curl", "lever-kneeling-leg-curl"], "lever-kneeling-leg-curl": ["lever-seated-leg-curl", "lever-lying-leg-curl"], "cable-seated-crunch": ["cable-kneeling-crunch", "crunch-floor", "lever-seated-crunch"], "lever-leg-extension": ["barbell-back-squat", "barbell-front-squat"], "barbell-front-squat": ["lever-leg-extension", "barbell-back-squat"], "cable-underhand-pulldown": ["cable-lateral-pulldown-with-v-bar", "lever-front-pulldown", "pull-up-neutral-grip"], "chin-up": ["dumbbell-one-arm-bent-over-row", "dumbbell-incline-row", "cable-lateral-pulldown-with-v-bar"], "cable-rope-seated-row": ["cable-seated-row", "lever-seated-row", "lever-t-bar-row"], "lever-t-bar-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row", "cable-seated-row"], "barbell-curl": ["dumbbell-incline-curl", "dumbbell-standing-biceps-curl", "lever-preacher-curl"], "dumbbell-biceps-curl": ["ez-barbell-curl", "barbell-curl"], "hanging-leg-raise": ["hanging-straight-leg-raise", "captains-chair-straight-leg-raise"], "hanging-straight-leg-raise": ["hanging-leg-raise", "captains-chair-straight-leg-raise"], "captains-chair-straight-leg-raise": ["hanging-leg-raise", "hanging-straight-leg-raise"], "pull-up-neutral-grip": ["cable-lateral-pulldown-with-v-bar", "cable-underhand-pulldown", "cable-pulldown"], "crunch-floor": ["cable-kneeling-crunch", "cable-seated-crunch"], "cable-hammer-curl-with-rope": ["dumbbell-incline-curl", "dumbbell-hammer-curl"], "dumbbell-hammer-curl": ["dumbbell-cross-body-hammer-curl", "dumbbell-standing-reverse-curl", "dumbbell-incline-curl"], "dumbbell-reverse-wrist-curl": ["barbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "barbell-reverse-wrist-curl"], "barbell-reverse-wrist-curl": ["dumbbell-reverse-wrist-curl", "cable-reverse-wrist-curl"], "cable-seated-wide-grip-row": ["lever-t-bar-row", "dumbbell-incline-row", "lever-high-row"], "lever-high-row": ["cable-seated-wide-grip-row", "dumbbell-incline-row"], "lever-preacher-curl": ["dumbbell-incline-curl", "barbell-curl"], "dumbbell-one-arm-bent-over-row": ["dumbbell-incline-row", "cable-seated-row", "chin-up"], "barbell-standing-close-grip-military-press": ["dumbbell-seated-shoulder-press", "dumbbell-standing-overhead-press"], "dumbbell-standing-overhead-press": ["dumbbell-seated-shoulder-press", "barbell-standing-close-grip-military-press"], "dumbbell-upright-row": ["cable-one-arm-lateral-raise", "dumbbell-lateral-raise"], "dumbbell-lying-triceps-extension": ["cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown"], "cable-standing-rear-delt-row-with-rope": ["dumbbell-reverse-fly", "dumbbell-rear-lateral-raise"], "dumbbell-rear-lateral-raise": ["dumbbell-reverse-fly", "cable-standing-rear-delt-row-with-rope"], "dumbbell-cross-body-hammer-curl": ["dumbbell-hammer-curl", "dumbbell-standing-reverse-curl"]});
...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Flat press and shoulders", "focus": "Chest, lat-biased rowing and overhead pressing", "groups": [{"id": "A1", "name": "Upper body A", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "dumbbell-incline-bench-press"], "sets": 3, "min": 6, "max": 10, "rir": 2, "rest": 180, "note": "Main chest press while fresh. Use a low incline if choosing the third option; this changes the chest emphasis."}, {"options": ["dumbbell-one-arm-bent-over-row", "dumbbell-incline-row", "cable-seated-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Lat-biased row separates the presses. Keep elbows close and pull towards the hip or lower ribs without twisting. Support the free hand for one-arm rows and the chest for incline rows."}, {"options": ["dumbbell-seated-shoulder-press", "barbell-standing-close-grip-military-press", "dumbbell-standing-overhead-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Overhead pressing after a pulling break. Two sets supplement chest pressing; overhead-press performance is secondary to the first chest exercise."}, {"options": ["cable-one-arm-lateral-raise", "dumbbell-lateral-raise", "dumbbell-upright-row"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Direct lateral-delt work after pressing. Cable raises are strictly unilateral; dumbbell lateral raises cover the other gym. Upright rows add trap involvement: use a comfortable wide hand path and keep elbows below shoulder height."}, {"options": ["dumbbell-standing-biceps-curl", "barbell-curl", "dumbbell-incline-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "A's standing supinated curl provides direct biceps work after rowing. The incline alternative changes shoulder position but preserves the supinated-curl role."}, {"options": ["cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown", "dumbbell-lying-triceps-extension"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Direct triceps work after all pressing. Pushdowns provide stable resistance; the dumbbell extension covers an occupied cable station."}]}]}, {"id": "B", "name": "Back and incline press", "focus": "Mid-back, upper chest and incline curls", "groups": [{"id": "B1", "name": "Upper body B", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-row", "cable-seated-row", "dumbbell-one-arm-bent-over-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Mid-back work first while fresh. Pull towards the lower chest with elbows about 45 degrees from the torso and controlled shoulder-blade movement. Use chest support for incline rows and hand support for one-arm rows."}, {"options": ["dumbbell-incline-bench-press", "dumbbell-bench-press", "barbell-bench-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 180, "note": "Low-incline chest press after rowing. Flat alternatives preserve the chest slot but reduce its incline emphasis."}, {"options": ["cable-one-arm-lateral-raise", "dumbbell-lateral-raise", "dumbbell-upright-row"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Second lateral-delt exposure after the main lifts. Cable raises are strictly unilateral; dumbbell lateral raises cover the other gym. For upright rows, use a comfortable wide hand path and keep elbows below shoulder height."}, {"options": ["dumbbell-seated-triceps-extension", "cable-overhead-triceps-extension-rope-attachment", "dumbbell-standing-triceps-extension"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Overhead triceps work complements A's pushdowns. This slot provides a break after pressing and separates any upright-row and rear-delt-row alternatives."}, {"options": ["dumbbell-reverse-fly", "cable-standing-rear-delt-row-with-rope", "dumbbell-rear-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "Two dedicated rear-delt sets after the main lifts. Support the chest on an incline bench for dumbbell options. The rope alternative is a rear-delt row, not an exact face pull."}, {"options": ["dumbbell-incline-curl", "dumbbell-standing-biceps-curl", "barbell-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "B's incline supinated curl changes shoulder position from A. Keep the upper arm behind the torso without forcing the shoulder. Standing alternatives preserve biceps work but lose the incline position. Curl after all pulling."}]}]}, {"id": "C", "name": "Back priority and arms", "focus": "Two back slots, chest and combined biceps and forearm work", "groups": [{"id": "C1", "name": "Upper body C", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-one-arm-bent-over-row", "dumbbell-incline-row", "chin-up"], "sets": 3, "min": 6, "max": 10, "rir": 2, "rest": 180, "note": "Lat-biased pulling first while fresh. For rows, use support, keep elbows close and pull towards the hip or lower ribs. Chin-ups are conditional: choose them only where a secure bar exists and three sets of at least six controlled repetitions are possible with two repetitions in reserve. Otherwise choose a row. No assistance machine is assumed."}, {"options": ["dumbbell-bench-press", "barbell-bench-press", "dumbbell-incline-bench-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 180, "note": "Chest pressing separates the two back slots. Back receives first priority today. Use a low incline if choosing the third option."}, {"options": ["dumbbell-incline-row", "cable-seated-row", "dumbbell-one-arm-bent-over-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Additional mid-back row raises weekly main back work to twelve sets. Pull towards the lower chest with elbows about 45 degrees from the torso. Use chest support for incline rows and hand support for one-arm rows. Chest pressing separates this from the first pull."}, {"options": ["cable-pushdown-with-rope-attachment", "dumbbell-lying-triceps-extension", "cable-one-arm-tricep-pushdown"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Complete six weekly direct triceps sets after the main lifts. This slot separates the second back row from the optional rear-delt row."}, {"options": ["dumbbell-reverse-fly", "cable-standing-rear-delt-row-with-rope", "dumbbell-rear-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "One dedicated rear-delt set; B retains two. One set was transferred to the additional back row, which also involves rear delts. Support the chest for dumbbell options. The rope alternative adds more mid-back and elbow-flexor work."}, {"options": ["dumbbell-hammer-curl", "dumbbell-cross-body-hammer-curl", "dumbbell-standing-reverse-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 90, "note": "C's combined biceps and forearm slot, and the week's only dedicated forearm slot. Hammer and cross-body curls use a neutral grip; reverse curls use a pronated grip and reduce biceps emphasis. Keep wrists straight. These sets count once towards workload. Last so grip fatigue cannot limit rows."}]}]}]}};
...
/* The two coached programmes, with the trade-off stated rather than implied.
   ...
   not a migration. */
const SPACING = {"back": {"days": ["A", "B", "C"], "weeklySets": 12, "minRecoveryDays": 2, "verdict": "Three main back sets on A, three on B and six on C. C's two pulls are separated by chest pressing. Default: twelve rowing sets. Conditional chin-up choice: nine rowing sets and three vertical-pulling sets."}, "chest": {"days": ["A", "B", "C"], "weeklySets": 9, "minRecoveryDays": 2, "verdict": "Three pressing sets per session, separated by 48, 48 and 72 hours. Chest volume is unchanged; C now gives back first priority."}, "lats": {"days": ["A", "B", "C"], "weeklySets": 12, "minRecoveryDays": 2, "verdict": "Twelve shared main back sets, including six with a lat bias. These are the same physical sets reported under back and mid-back, not additional volume. C can replace three lat-biased rowing sets with conditional chin-ups."}, "mid-back": {"days": ["A", "B", "C"], "weeklySets": 12, "minRecoveryDays": 2, "verdict": "Default: twelve shared rowing sets, including six with a mid-back bias. Choosing chin-ups on C reduces the rowing-specific allocation to nine sets; chin-ups are not counted as equivalent scapular-retraction work."}, "front-delts": {"days": ["A"], "weeklySets": 2, "minRecoveryDays": 7, "verdict": "Two dedicated overhead-press sets repeat weekly. Chest pressing also loads front delts on A, B and C, with a minimum 48-hour gap between total exposures."}, "lateral-delts": {"days": ["A", "B"], "weeklySets": 4, "minRecoveryDays": 2, "verdict": "Two direct sets on Monday and Wednesday, with gaps of 48 and 120 hours. Overhead-press contributions are excluded."}, "rear-delts": {"days": ["B", "C"], "weeklySets": 3, "minRecoveryDays": 2, "verdict": "Two dedicated sets on B and one on C, with gaps of 48 and 120 hours. One isolation set funds extra back work. Rows provide additional involvement on all three days."}, "biceps": {"days": ["A", "B", "C"], "weeklySets": 6, "minRecoveryDays": 2, "verdict": "Two standing supinated-curl sets on A, two incline-curl sets on B and two hammer-curl sets on C. C's sets also serve forearms and count once towards total workload. Reverse curls reduce biceps emphasis. Main pulling contributions are excluded."}, "triceps": {"days": ["A", "B", "C"], "weeklySets": 6, "minRecoveryDays": 2, "verdict": "Two direct sets each session, including overhead extensions on B. Pressing contributions are excluded from this direct total."}, "forearms": {"days": ["C"], "weeklySets": 2, "minRecoveryDays": 7, "verdict": "One dedicated slot, shared with C's hammer curls and targeting brachioradialis. Cross-body or reverse curls replace that slot; they do not add another. Gripping adds exposure on A, B and C. No isolated wrist work."}};
...
if(!state.settings.programAppliedV6 && !state.session){
  try{
    ...
    state.settings.programAppliedV6 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
