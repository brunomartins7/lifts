...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Flat press and pull", "focus": "Flat chest, lats, front and lateral delts, arms", "groups": [{"id": "A1", "name": "Press and row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "barbell-incline-bench-press"], "sets": 3, "min": 6, "max": 10, "rir": 2, "rest": 150, "note": "Heaviest press of the week, first while you are fresh."}, {"options": ["dumbbell-one-arm-bent-over-row", "barbell-bent-over-row", "cable-seated-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "Lats through shoulder extension. One of your originals."}]}, {"id": "A2", "name": "Delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-seated-shoulder-press", "barbell-standing-close-grip-military-press", "dumbbell-standing-overhead-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Front delts, pressed directly rather than left to the bench."}, {"options": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise", "dumbbell-upright-row"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "Lateral delts. The only dumbbell lateral raise in the week."}]}, {"id": "A3", "name": "Arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-triceps-pushdown-v-bar", "cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Lateral and medial triceps. One of your originals."}, {"options": ["dumbbell-standing-biceps-curl", "barbell-curl", "cable-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Supinated curl. One of your originals."}]}]}, {"id": "B", "name": "Dumbbell press and mid-back", "focus": "Flat dumbbell chest, mid-back, lateral and rear delts, arms", "groups": [{"id": "B1", "name": "Press and row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-bench-press", "barbell-bench-press", "dumbbell-incline-bench-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Flat pressing with dumbbells, a different loading pattern to the bar."}, {"options": ["dumbbell-incline-row", "cable-seated-row", "barbell-bent-over-row"], "sets": 3, "min": 10, "max": 12, "rir": 2, "rest": 120, "note": "Chest supported so the back works, not the hips. One of your originals."}]}, {"id": "B2", "name": "Delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-lateral-raise", "cable-one-arm-lateral-raise", "dumbbell-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "Lateral delts on cables, so the tension does not fall off at the bottom."}, {"options": ["cable-standing-rear-delt-row-with-rope", "dumbbell-reverse-fly", "dumbbell-rear-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "Face pulls. Rear delts, and one of your originals."}]}, {"id": "B3", "name": "Arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-standing-triceps-extension", "dumbbell-seated-triceps-extension", "ez-bar-standing-french-press"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Overhead french press for the triceps long head. One of your originals."}, {"options": ["dumbbell-cross-body-hammer-curl", "dumbbell-hammer-curl", "cable-hammer-curl-with-rope"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Brachialis and brachioradialis. One of your originals."}]}]}, {"id": "C", "name": "Incline press and back", "focus": "Upper chest, back thickness, rear delts, triceps and forearms", "groups": [{"id": "C1", "name": "Incline and row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-bench-press", "barbell-incline-bench-press", "dumbbell-incline-fly"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Upper chest. Replaces the fly, and one of your originals."}, {"options": ["cable-seated-row", "cable-seated-wide-grip-row", "cable-rope-seated-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "Back thickness. One of your originals."}]}, {"id": "C2", "name": "Rear delts and back", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-reverse-fly", "dumbbell-rear-lateral-raise", "cable-cross-over-revers-fly"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "Rear delts, direct. Placed between the two pulls so they are not back to back."}, {"options": ["barbell-bent-over-row", "barbell-pendlay-row", "dumbbell-one-arm-bent-over-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "Heaviest row of the week, for mid-back thickness."}]}, {"id": "C3", "name": "Triceps and forearms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-seated-triceps-extension", "cable-pushdown-with-rope-attachment"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Triceps long head overhead. One of your originals."}, {"options": ["barbell-reverse-curl", "dumbbell-standing-reverse-curl", "cable-reverse-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "Brachioradialis and forearm extensors. One of your originals."}]}]}]}};
...
/* The two coached programmes, with the trade-off stated rather than implied.
   ...
   not a migration. */
const SPACING = {"chest": {"days": ["A", "B", "C"], "weeklySets": 9, "minRecoveryDays": 1, "verdict": "Trained on A and B and C. You never train two days running, so that is at least 48 hours each time."}, "back": {"days": ["A", "B", "C"], "weeklySets": 12, "minRecoveryDays": 1, "verdict": "Trained on A and B and C. You never train two days running, so that is at least 48 hours each time."}, "shoulders": {"days": ["A", "B", "C"], "weeklySets": 15, "minRecoveryDays": 1, "verdict": "Trained on A and B and C. You never train two days running, so that is at least 48 hours each time."}, "triceps": {"days": ["A", "B", "C"], "weeklySets": 9, "minRecoveryDays": 1, "verdict": "Trained on A and B and C. You never train two days running, so that is at least 48 hours each time."}, "biceps": {"days": ["A", "B"], "weeklySets": 6, "minRecoveryDays": 2, "verdict": "Trained on A and B. You never train two days running, so that is at least 48 hours each time."}, "forearms": {"days": ["C"], "weeklySets": 3, "minRecoveryDays": 2, "verdict": "Trained on C. You never train two days running, so that is at least 48 hours each time."}};
...
if(!state.settings.programAppliedV9 && !state.session){
  try{
    ...
    state.settings.programAppliedV9 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
