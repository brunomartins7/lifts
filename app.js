...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Chest and arms", "focus": "Flat and incline pressing, one row, lateral delts, one curl", "groups": [{"id": "A1", "name": "Press and row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "cable-seated-chest-press"], "sets": 3, "min": 6, "max": 10, "rir": 2, "rest": 150, "note": "Heaviest press of the week, first while you are fresh."}, {"options": ["dumbbell-one-arm-bent-over-row", "barbell-bent-over-row", "cable-seated-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "A row between the two presses, so your chest is not pressing twice in a row."}]}, {"id": "A2", "name": "Incline and delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-bench-press", "barbell-incline-bench-press", "barbell-bench-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Upper chest."}, {"options": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise", "cable-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "The only raise today, so it gets a fresh shoulder."}]}, {"id": "A3", "name": "Arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-triceps-pushdown-v-bar", "cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Triceps."}, {"options": ["dumbbell-standing-biceps-curl", "barbell-curl", "cable-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "The only curl today."}]}]}, {"id": "B", "name": "Back and arms", "focus": "Two rows, one flat press, lateral delts, one curl", "groups": [{"id": "B1", "name": "Row and press", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-row", "cable-seated-row", "dumbbell-one-arm-bent-over-row"], "sets": 3, "min": 10, "max": 12, "rir": 2, "rest": 120, "note": "Chest supported, so your back works and your hips cannot cheat."}, {"options": ["dumbbell-bench-press", "barbell-bench-press", "cable-seated-chest-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Flat pressing with dumbbells. Also keeps the two rows apart."}]}, {"id": "B2", "name": "Row and delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-seated-row", "cable-seated-wide-grip-row", "barbell-bent-over-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "Back thickness."}, {"options": ["cable-one-arm-lateral-raise", "dumbbell-lateral-raise", "cable-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "One arm at a time, and the only raise today."}]}, {"id": "B3", "name": "Arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-overhead-triceps-extension-rope-attachment", "dumbbell-standing-triceps-extension", "dumbbell-seated-triceps-extension"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Overhead, which is what loads the triceps long head."}, {"options": ["dumbbell-cross-body-hammer-curl", "dumbbell-hammer-curl", "dumbbell-standing-biceps-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "The only curl today."}]}]}, {"id": "C", "name": "Shoulders and pull", "focus": "Overhead pull, shoulder press, rear delts, triceps, forearms", "groups": [{"id": "C1", "name": "Pull and press", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-straight-arm-pulldown", "dumbbell-pullover", "pull-up"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "The one overhead pulling pattern you can train without a bar."}, {"options": ["dumbbell-seated-shoulder-press", "barbell-seated-overhead-press", "dumbbell-standing-overhead-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Front delts."}]}, {"id": "C2", "name": "Rear delts and triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-standing-rear-delt-row-with-rope", "cable-cross-over-revers-fly", "dumbbell-rear-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "Rear delts on a cable, so the tension holds all the way through. One of your originals."}, {"options": ["barbell-lying-triceps-extension-skull-crusher", "ez-bar-standing-french-press", "dumbbell-lying-triceps-extension"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Skull crushers."}]}, {"id": "C3", "name": "Forearms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-standing-reverse-curl", "cable-reverse-curl", "barbell-reverse-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "Brachioradialis, dumbbells rather than a bar. The only elbow flexion today."}, {"options": ["dumbbell-over-bench-wrist-curl", "dumbbell-seated-palms-up-wrist-curl", "dumbbell-reverse-wrist-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "One arm over a bench. Wrist flexors, and the only day they appear."}]}]}]}};
...
function renderExercise(ex,dayIndex,groupId,baseId=ex.id){
  ...
  /* The written guide sits behind a disclosure, so in practice he never saw it.
     One cue — the thing that decides whether the set works — is always on screen. */
  const coach=COACHING[ex.id];
  const keyCue=coach?(coach.grow&&coach.grow[0])||(coach.execute&&coach.execute[0])||'':'';
...
if(!state.settings.programAppliedV14 && !state.session){
  try{
    ...
    state.settings.programAppliedV14 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
