...
if(!state.settings.programAppliedV12 && !state.session){
  try{
    ...
    state.settings.programAppliedV12 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
