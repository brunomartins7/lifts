...
const DEFAULT_PLAN = [
 {id:'A',name:'Push',focus:'Chest Lead, Shoulders, Triceps',groups:[
  {id:'A1',name:'Primary Press Pair',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
  ...
  {id:'A2',name:'Shoulder And Chest Detail',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
  ...
  {id:'A3',name:'Arm Finisher',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
 ...
 {id:'B',name:'Pull',focus:'Back Lead, Rear Delts, Biceps',groups:[
  {id:'B1',name:'Core And Row Base',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
  ...
  {id:'B2',name:'Upper Back Control',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
  ...
  {id:'B3',name:'Biceps And Forearms',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
 ...
 {id:'C',name:'Shoulders And Arms',focus:'Delts, Arms, Upper Back Detail',groups:[
  {id:'C1',name:'Vertical Press And Width',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
  ...
  {id:'C2',name:'Pump Press And Rear Delts',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
  ...
  {id:'C3',name:'Arm Superset',rule:'Straight sets. Finish all sets of one exercise, then move on.',exercises:[
...
const PRESETS = {"upper": {"name": "Upper body", "days": [{"id": "A", "name": "Chest and triceps", "focus": "Your old Day A: two presses, lateral delts, two triceps — with a pull added", "groups": [{"id": "A1", "name": "Press and pull", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["barbell-bench-press", "dumbbell-bench-press", "cable-seated-chest-press"], "sets": 3, "min": 6, "max": 10, "rir": 2, "rest": 150, "note": "Heaviest press of the week, first while you are fresh."}, {"options": ["cable-straight-arm-pulldown", "dumbbell-pullover", "pull-up"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Took the rear delt fly's place. The one overhead pull you can train without a bar, and it stops the day being nothing but pressing."}]}, {"id": "A2", "name": "Incline and delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-bench-press", "barbell-incline-bench-press", "barbell-bench-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Upper chest."}, {"options": ["dumbbell-lateral-raise", "cable-one-arm-lateral-raise", "cable-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "The only raise today, so it gets a fresh shoulder."}]}, {"id": "A3", "name": "Triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-standing-triceps-extension", "dumbbell-seated-triceps-extension", "cable-overhead-triceps-extension-rope-attachment"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Dumbbells rather than the cable, as you asked. Overhead is what loads the long head."}, {"options": ["cable-pushdown-with-rope-attachment", "cable-one-arm-tricep-pushdown", "dumbbell-lying-triceps-extension"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Rope instead of the V-bar. This is the only thing in the week that loads the lateral head."}]}]}, {"id": "B", "name": "Back and biceps", "focus": "Your old Day B: two rows, lateral delts, arms — with a press so it is not four pulls", "groups": [{"id": "B1", "name": "Row and press", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-one-arm-bent-over-row", "barbell-bent-over-row", "cable-seated-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "Lats, one side at a time."}, {"options": ["dumbbell-bench-press", "barbell-bench-press", "cable-seated-chest-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Moved here off Day C. It keeps the two rows apart and gives the week a third press."}]}, {"id": "B2", "name": "Row and delts", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-row", "cable-rope-seated-row", "cable-seated-wide-grip-row"], "sets": 3, "min": 10, "max": 12, "rir": 2, "rest": 120, "note": "Chest supported, so your back works and your hips cannot cheat."}, {"options": ["cable-one-arm-lateral-raise", "dumbbell-lateral-raise", "cable-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "One arm at a time, and the only raise today."}]}, {"id": "B3", "name": "Arms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-standing-reverse-curl", "cable-reverse-curl", "barbell-reverse-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "Dumbbells, not the bar. The only wrist extensor work in the week."}, {"options": ["dumbbell-cross-body-hammer-curl", "dumbbell-hammer-curl", "dumbbell-standing-biceps-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "The only curl today."}]}]}, {"id": "C", "name": "Shoulders and top-ups", "focus": "Your old Day C: shoulder press, a row, skull crushers, a curl — and an easier forearm finisher", "groups": [{"id": "C1", "name": "Press and row", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-seated-shoulder-press", "barbell-seated-overhead-press", "dumbbell-standing-overhead-press"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 150, "note": "Front delts."}, {"options": ["cable-seated-row", "cable-seated-wide-grip-row", "barbell-bent-over-row"], "sets": 3, "min": 8, "max": 12, "rir": 2, "rest": 120, "note": "Back thickness."}]}, {"id": "C2", "name": "Rear delts and triceps", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["cable-standing-rear-delt-row-with-rope", "cable-cross-over-revers-fly", "dumbbell-rear-lateral-raise"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 75, "note": "Face pulls, moved here off Day B so they are not done on the same day as a lateral raise."}, {"options": ["barbell-lying-triceps-extension-skull-crusher", "ez-bar-standing-french-press", "dumbbell-lying-triceps-extension"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Skull crushers, kept where you had them."}]}, {"id": "C3", "name": "Arms and forearms", "rule": "Straight sets. Finish all sets of one exercise, then move on.", "slots": [{"options": ["dumbbell-incline-curl", "dumbbell-standing-biceps-curl", "cable-curl"], "sets": 3, "min": 10, "max": 15, "rir": 2, "rest": 90, "note": "Incline, which is the long head of the biceps."}, {"options": ["dumbbell-over-bench-wrist-curl", "dumbbell-seated-palms-up-wrist-curl", "dumbbell-reverse-wrist-curl"], "sets": 3, "min": 12, "max": 20, "rir": 2, "rest": 60, "note": "The easier forearm movement that replaced the barbell reverse curl. One arm over a bench."}]}]}]}};
/* Corrections to the bank, from a pass over all 145 entries. Most are increments:
   a 2.5kg jump is not available on a cable stack that moves in 5s, so the app was
   prescribing loads the machine cannot make. The rest are rep ranges that did not
   suit the movement, and start or goal loads set for a stronger trainee. */
const BANK_FIX = {"dumbbell-fly": {"min": 8, "max": 12, "startWeight": 7.5, "goalWeight": 15}, "dumbbell-incline-fly": {"min": 8, "max": 12, "startWeight": 7.5, "goalWeight": 15}, "cable-standing-fly": {"inc": 5}, "cable-upper-chest-crossovers": {"inc": 5}, "cable-seated-chest-press": {"inc": 5}, "cable-seated-row": {"inc": 5}, "cable-rope-seated-row": {"inc": 5}, "cable-seated-wide-grip-row": {"inc": 5}, "cable-pulldown": {"inc": 5}, "cable-lateral-pulldown-with-v-bar": {"inc": 5}, "cable-underhand-pulldown": {"inc": 5}, "cable-straight-arm-pulldown": {"min": 12, "max": 15, "inc": 5}, "cable-shrug": {"inc": 5}, "cable-lateral-raise": {"inc": 5, "startWeight": 5}, "cable-one-arm-lateral-raise": {"inc": 5, "startWeight": 5}, "dumbbell-lateral-raise": {"min": 12, "max": 20, "startWeight": 5, "goalWeight": 12.5}, "dumbbell-front-raise": {"min": 12, "max": 20, "startWeight": 5, "goalWeight": 12.5}, "dumbbell-rear-lateral-raise": {"min": 12, "max": 20, "startWeight": 5, "goalWeight": 12.5}, "dumbbell-reverse-fly": {"min": 12, "max": 20, "startWeight": 5, "goalWeight": 12.5}, "cable-standing-rear-delt-row-with-rope": {"inc": 5, "startWeight": 5}, "cable-cross-over-revers-fly": {"inc": 5, "startWeight": 5}, "dumbbell-incline-curl": {"startWeight": 7.5, "goalWeight": 15}, "dumbbell-concentration-curl": {"startWeight": 7.5, "goalWeight": 15}, "dumbbell-preacher-curl": {"startWeight": 7.5, "goalWeight": 15}, "dumbbell-zottman-curl": {"startWeight": 5, "goalWeight": 12.5}, "barbell-close-grip-bench-press": {"startWeight": 20}, "cable-curl": {"inc": 5, "startWeight": 10}, "cable-hammer-curl-with-rope": {"inc": 5, "startWeight": 10}, "cable-one-arm-curl": {"inc": 5, "startWeight": 10, "goalWeight": 20}, "cable-triceps-pushdown-v-bar": {"inc": 5, "goalWeight": 35}, "cable-pushdown-with-rope-attachment": {"inc": 5, "goalWeight": 35}, "cable-overhead-triceps-extension-rope-attachment": {"inc": 5, "goalWeight": 35}, "cable-one-arm-tricep-pushdown": {"inc": 5, "startWeight": 10, "goalWeight": 20}, "cable-kickback": {"inc": 5, "startWeight": 5, "goalWeight": 15}, "dumbbell-lying-triceps-extension": {"startWeight": 7.5, "goalWeight": 15}, "dumbbell-kickback": {"startWeight": 5, "goalWeight": 10}, "cable-wrist-curl": {"inc": 5}, "cable-reverse-wrist-curl": {"inc": 5}, "barbell-reverse-curl": {"min": 12, "max": 20, "startWeight": 5}, "cable-reverse-curl": {"inc": 5}, "finger-curls": {"min": 12, "max": 20}, "wrist-rollerer": {"min": 2, "max": 4}, "cable-kneeling-crunch": {"inc": 5}, "cable-seated-crunch": {"inc": 5}, "cable-pull-through": {"inc": 5}, "barbell-bench-press": {"startWeight": 20}, "barbell-incline-bench-press": {"startWeight": 20}, "dumbbell-bench-press": {"startWeight": 7.5}, "dumbbell-incline-bench-press": {"startWeight": 7.5}, "dumbbell-seated-palms-up-wrist-curl": {"startWeight": 2.5}, "barbell-wrist-curl": {"startWeight": 5}};

/* Plain names. "Cable Standing Rear Delt Row With Rope" is a face pull, and
...
function repairProgram(p){
  ...
  const out = p.map((day,di)=>({
    ...
    groups: (Array.isArray(day.groups)&&day.groups.length?day.groups:base[di]?.groups||[]).map((g,gi)=>({
      ...
      name: g.name || 'Group',
      rule: g.rule || 'Straight sets. Finish all sets of one exercise, then move on.',
...
function muscleBasedTarget(ex){
  ...
  /* peers keep unavailable machines: he may still have history on one */
...
/* The load to progress from is the one most of the working sets used, not the
   heaviest number in the entry. After 30x10, 25x8, 25x8 the honest reading is
   25kg — prescribing 30kg for all three sets next time asks for work that was
   never completed. Ties go to the heavier load. */
function representativeLoad(entry){
  if(!Array.isArray(entry.weights)||!entry.weights.length) return Number(entry.weight)||0;
  const counts={};
  for(const w of entry.weights){ const k=Number(w)||0; counts[k]=(counts[k]||0)+1; }
  let best=0,bestN=-1;
  for(const k of Object.keys(counts).map(Number).sort((a,b)=>b-a)) if(counts[k]>bestN){ bestN=counts[k]; best=k; }
  return best;
}
function repsAtLoad(entry,load){
  if(!Array.isArray(entry.weights)||!entry.weights.length) return (entry.reps||[]).slice();
...
function targetFromLast(ex,last){
  ...
  let reps=repsAtLoad(last,weight).slice(0,Math.min(6,targetSets));
  while(reps.length<targetSets&&reps.length<6)reps.push(ex.min);
  /* Falling under the rep floor means the load was too heavy. The old rule left
     the weight alone and added a rep to the first sub-max set, so a movement
     that was already failing could be prescribed unchanged indefinitely. */
  const belowFloor=reps.some(r=>r>0&&r<Number(ex.min));
  if(belowFloor&&ex.scoreMode!=='reps'){
    return {weight:Math.max(0,Number((weight-inc).toFixed(1))),
            reps:Array.from({length:Number(ex.sets)||3},()=>Number(ex.min)||8),
            backedOff:true};
  }
  const allTop=reps.every(r=>r>=ex.max);
  if(allTop&&ex.scoreMode!=='reps'){weight=Number((weight+inc).toFixed(1));reps=Array.from({length:Number(ex.sets)||3},()=>ex.min)}
...
/* Equipment he has confirmed he does not have: no pec deck, no T-bar, no
   seated pulldown station, no fixed lever or sled machines. Movements needing
   only an adjustable pulley — a straight-arm pulldown, say — remain available.
   A swap list that offers a machine he lacks
   is worse than no swap list, because he reads it standing at the rack with a
   session running. Kept as a pattern rather than a list so a new bank entry of
   the same kind is excluded automatically. */
const UNAVAILABLE = /^(lever-|sled-)|smith-|^cable-(pulldown|lateral-pulldown|underhand-pulldown)/;
function isAvailable(b){ return Boolean(b) && !UNAVAILABLE.test(b.id); }
...
function swapTiers(ex){
  const pat=patternOf(ex);
  const sameMuscle=b=>isAvailable(b) && b.id!==ex.id && b.clip!==ex.clip && b.muscle===ex.muscle;
  const curated=(ALTERNATIVES[ex.id]||[]).map(id=>BANK.find(b=>b.id===id)).filter(isAvailable);
...
function extraSuggestions(){
  ...
  const c=completion();
  /* It used to hide until the session was 80% done, which meant he never
     discovered it existed. It is always visible now and simply says when it is
     too early to be worth acting on. */
  const early=!c.total||c.done<c.total*0.8;
  ...
  const pick=(muscle,n)=>{
    ...
    const fromBank=BANK.filter(b=>isAvailable(b)&&b.muscle===muscle&&!active.has(b.id)&&b.type==='isolation');
    return [...inProgram,...fromBank].filter((x,i,a)=>a.findIndex(y=>y.id===x.id)===i).slice(0,n);
  };
  if(early) return {early:true,reason:'Finish the session first. Once you are near the end this will suggest whatever your week is short of.'};
...
/* Working towards a first pull-up with no bar to practise on. These are the
   lifts he already does, at loads that indicate enough pulling strength to move
   78kg — provisional rules of thumb, not validated tests, and deliberately
   labelled as such. A target counts once it has been hit cleanly in two separate
   sessions. */
const PULLUP_TARGETS = [
  {id:'dumbbell-one-arm-bent-over-row', weight:30, reps:10, why:'about 38% of bodyweight in one hand'},
  {id:'cable-seated-row',               weight:60, reps:10, why:'about 77% of bodyweight, if the stack is honest'},
  {id:'dumbbell-cross-body-hammer-curl',weight:15, reps:10, why:'elbow flexion, about 19% of bodyweight a hand'}
];
function pullupProgress(){
  return PULLUP_TARGETS.map(t=>{
    const ex=exById(t.id);
    const hist=sessionsForEx(ex);
    const hits=hist.filter(h=>representativeLoad(h.entry)>=t.weight-0.01
      && (h.entry.reps||[]).some(r=>Number(r)>=t.reps)).length;
    let bestW=0,bestR=0;
    for(const h of hist){
      const w=representativeLoad(h.entry), r=Math.max(0,...(h.entry.reps||[]).map(Number));
      if(w>bestW||(w===bestW&&r>bestR)){bestW=w;bestR=r}
    }
    return {name:ex.name,target:t,hits,done:hits>=2,bestW,bestR,logged:hist.length};
  });
}
function renderPullupGoal(){
  const rows=pullupProgress();
  const done=rows.filter(r=>r.done).length;
  return `<div class="section"><h2>Working towards</h2><span>First pull-up</span></div>
  <div class="card"><div class="row" style="padding-top:0"><div><strong>Your first pull-up</strong><div class="small faint">No bar at either gym, so the plan is to build the strength now and learn the movement the day you get one.</div></div><div class="pill">${done}/3</div></div>
  ${rows.map(r=>`<div class="row"><div><strong>${esc(r.name)}</strong><div class="small faint">${r.logged?`Best so far ${fmtKg(r.bestW)} × ${r.bestR}`:'Not logged yet'} · ${esc(r.target.why)}</div></div><div class="mono" style="color:${r.done?'var(--ok)':'var(--muted)'}">${fmtKg(r.target.weight)}×${r.target.reps}${r.done?' ✓':r.hits?` · ${r.hits}/2`:''}</div></div>`).join('')}
  <div class="small muted" style="margin-top:10px">Day B's straight-arm pulldown is the one overhead pulling pattern you can train without a bar. It is the closest thing available; it is not the same as hanging from one.</div>
  <div class="small faint" style="margin-top:7px">These numbers are rules of thumb, not a tested readiness standard — pulldown and pull-up strength correlate at about r = 0.78, which is overlap rather than a threshold. A target counts once you have hit it cleanly in two separate sessions. The first time you find a bar: one strict attempt while fresh, then three sets of three to five foot-assisted reps, or slow negatives if there is nothing to push off.</div></div>`;
}
function renderHome(){
...
function renderExtraCard(){
  ...
  if(sug.early) return `<div class="card extra-card"><div class="row" style="padding-top:0"><div><strong>Got time for more?</strong><div class="small faint">${esc(sug.reason)}</div></div><div class="pill">Later</div></div></div>`;
...
function renderWorkout(){
  ...
  <div class="level-head" style="margin-top:8px"><div><div class="eyebrow">Training for <span id="sess-clock">${Math.floor((Date.now()-(state.session?.startedAt||Date.now()))/60000)} min</span></div><div class="title title--compact">Day ${day.id}</div><div class="sub" style="margin-top:2px">${esc(day.name)}</div></div><div class="setcount"><b>${c.done}/${c.total}</b><span>sets done</span></div></div>
...
/* Move an exercise earlier or later in the day. The day is stored as groups of
   two, so a move can cross a group boundary — flatten, swap the two positions,
   and write them back where they were. Logged sets are keyed by exercise id, so
   nothing in the draft moves with it. */
function moveExercise(exId,dir){
  const dayIndex = state.session ? state.session.dayIndex : openDay;
  const day = planDay(dayIndex);
  const flat = [];
  day.groups.forEach((g,gi)=>g.exercises.forEach((ex,ei)=>flat.push({ex,gi,ei})));
  const i = flat.findIndex(x=>x.ex.id===exId);
  const j = i + dir;
  if(i<0 || j<0 || j>=flat.length) return;
  const a = flat[i], b = flat[j];
  day.groups[a.gi].exercises[a.ei] = b.ex;
  day.groups[b.gi].exercises[b.ei] = a.ex;
  state.settings.programUpdatedAt = new Date().toISOString();
  markDataChanged(); indexExercises(state); save(); render();
  flash(`${a.ex.name} moved ${dir<0?'earlier':'later'}.`);
}
function exercisePosition(exId,dayIndex){
  const day = planDay(dayIndex);
  const flat = day.groups.flatMap(g=>g.exercises);
  return {index: flat.findIndex(x=>x.id===exId), total: flat.length};
}
function renderExercise(ex,dayIndex,groupId,baseId=ex.id){
  const pos=exercisePosition(baseId,dayIndex);
  const hasHistory=hasExerciseHistory(ex);
  const nudge=overloadNudge(ex);
  /* The standing cue used to sit under every name. It said the same thing every
     session and pushed the one number he is actually chasing further down the
     card, so it lives in the technique panel now and nowhere else. */
  const lastSess=hasHistory?sessionsForEx(ex).slice(-1)[0].session:null;
  const lastWhen=lastSess?relTime(lastSess.timestamp||Date.parse(lastSess.date)||now()):'';
  ...
  /* What the old always-on meta line carried that was worth keeping: where an
     unfamiliar suggested number came from, and the fact that the target was
     pulled back after a set fell short. Both are silent unless they apply. */
  const warnLine=[
    d.estimatedFromMuscle?`Estimated from similar ${esc(MUSCLE_LABEL[ex.muscle].toLowerCase())} lifts`:'',
    target.backedOff?`<span style="color:var(--gold2)">Load reduced — last time fell under ${ex.min} reps</span>`:''
  ].filter(Boolean).join(' · ');
...
/* The two coached programmes, with the trade-off stated rather than implied.
   ...
   not a migration. */
const SPACING = {"chest": {"days": ["A", "C"], "weeklySets": 9, "minRecoveryDays": 3, "verdict": "Six sets on A and three on C. A to C is 96 hours; C to the next A is 72 hours."}, "lats": {"days": ["B", "C"], "weeklySets": 9, "minRecoveryDays": 2, "verdict": "Six rowing sets on B and three on C. Gaps are 48 and 120 hours. All work is horizontal; vertical pulling remains absent."}, "midBack": {"days": ["B", "C"], "weeklySets": 9, "minRecoveryDays": 2, "verdict": "The same nine main rowing sets also train the mid-back. Rear-delt work adds secondary involvement, including on A."}, "frontDelts": {"days": ["C"], "weeklySets": 3, "minRecoveryDays": 3, "verdict": "Dedicated shoulder pressing occurs once weekly, but chest pressing also loads front delts on A. Meaningful pressing exposures are separated by 96 and 72 hours."}, "lateralDelts": {"days": ["A", "B"], "weeklySets": 6, "minRecoveryDays": 2, "verdict": "Direct raises are 48 hours apart. Shoulder pressing on C adds secondary work another 48 hours later."}, "rearDelts": {"days": ["A", "B"], "weeklySets": 6, "minRecoveryDays": 2, "verdict": "Cable reverse fly on A and rope rear-delt row on B preserve two direct exposures. Main rows, including C, add secondary work."}, "biceps": {"days": ["B", "C"], "weeklySets": 9, "minRecoveryDays": 2, "verdict": "Six dedicated curl sets on B and three on C, with 48 and 120 hours between exposures. Rows and reverse curls add secondary loading."}, "triceps": {"days": ["A", "C"], "weeklySets": 9, "minRecoveryDays": 3, "verdict": "Six direct sets on A and three skull-crusher sets on C. Pressing adds substantial work on those same days; gaps are 96 and 72 hours."}, "forearms": {"days": ["B", "C"], "weeklySets": 6, "minRecoveryDays": 2, "verdict": "Three shared hammer-curl sets on B and three reverse-curl sets on C chiefly target brachioradialis. Rowing and other curls add grip demand; this is not comprehensive wrist-isolation work."}};
function renderPresetCard(){
  const on=state.settings.programPreset==='upper';
  const p=PRESETS.upper;
  const rows=Object.keys(SPACING).map(k=>{
    const v=SPACING[k];
    const label=k.replace(/([A-Z])/g,' $1').replace(/^./,c=>c.toUpperCase());
    return `<div class="row"><div><strong>${esc(label)}</strong><div class="small faint">${esc(v.days.join(' and '))} · ${v.minRecoveryDays===0?'can fall on back-to-back days':v.minRecoveryDays+' day'+(v.minRecoveryDays===1?'':'s')+' clear at worst'}</div></div><div class="mono">${v.weeklySets}</div></div>`;
  }).join('');
  return `<div class="section"><h2>Coached program</h2><span>${on?'Active':'Not applied'}</span></div>
  <div class="card"><div class="row" style="padding-top:0"><div><strong>Upper body, six exercises a day</strong><div class="small faint">Three sessions a week, never on consecutive days.</div></div>
  <button class="secondary ${on?'':'gold'}" data-action="apply-preset" data-preset="upper"${on?' disabled':''}>${on?'Active':'Apply'}</button></div>
  <div class="small muted" style="margin-top:2px">Direct sets a week, and how much recovery each gets in the worst ordering.</div>
  ${rows}
  <div class="small faint" style="margin-top:11px">Built on the assumption you never train two days running, so every muscle gets at least 48 hours and the volume is higher than a programme that has to survive three days back to back. No abdominal work — you took it out, and those slots paid for the wrist flexion, wrist extension and reverse curl that forearms actually need. Heavy pressing opens each session, pulling alternates with pressing, and grip work goes last so tired hands cannot spoil the pulling before it. Everything sits at two reps in reserve: training to failure is not required for growth and costs more recovery than it returns.</div>`;
}
...
app.addEventListener('click',e=>{
  ...
  else if(a==='move-ex-up')moveExercise(t.dataset.ex,-1);
  else if(a==='move-ex-down')moveExercise(t.dataset.ex,1);
...
/* A session left open used to block every future programme update, with no way
   back: the guard only asked whether a session existed, and an abandoned one
   from weeks ago counts. A session from an earlier day is not work in progress,
   so it no longer holds the programme hostage — only today's does. */
const sessionIsToday = Boolean(state.session) && state.session.date === today();
if(!state.settings.programAppliedV15 && !sessionIsToday){
  try{
    ...
    state.settings.programAppliedV15 = new Date().toISOString();
    state.settings.programUpdatedAt = new Date().toISOString();
